...
class OlTitBitVerificationQuestion extends Seeder
{
    ...
    public function run()
    {
		...
		$questionArr = [
            ...
            [                
            'language_id'   => $languageId,
                'question' => "अशी जागा स्वतंत्रपणे विकास करता येण्यासारखी आहे काय ?",
                'is_compulsory' => 0,
                'is_option' => 1,
                'is_select' => 0,
                'hide' => 1,
            ...
            [               
            'language_id'   => $languageId,
                'question' => "सदर जागा फुटकळ भूखंडाच्या  परिभाषेनुसार असल्यास त्याचे क्षेत्रफळ व मोजमापे नमुद करावीत.",
                'is_compulsory' => 0,
                'is_option' => 1,
                'is_select' => 0,
                'hide' => 1,
