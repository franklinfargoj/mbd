...
Route::prefix('appointing_architect')->group(function () {
    ...
    Route::middleware(['check-permission', 'auth', 'disablepreventback'])->group(function(){
        ...
        Route::get('step3', 'EmploymentOfArchitectController@step3')->name('appointing_architect.step3');
        Route::get('step4', 'EmploymentOfArchitectController@step4')->name('appointing_architect.step4');
        Route::get('step5', 'EmploymentOfArchitectController@step5')->name('appointing_architect.step5');
        Route::get('step6', 'EmploymentOfArchitectController@step6')->name('appointing_architect.step6');
        Route::get('step7', 'EmploymentOfArchitectController@step7')->name('appointing_architect.step7');
        Route::get('step8', 'EmploymentOfArchitectController@step8')->name('appointing_architect.step8');
    });
