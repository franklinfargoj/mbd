    ...
    <div class="m-subheader px-0">
        <div class="d-flex">
                    ...
                    $application->ArchitectApplicationStatusForLoginListing->count()<=0) Edit @else Back
                        ...
                        <div class="d-flex justify-content-between align-items-center form-steps-toplinks">
                            <a class="btn--unstyled section-title section-title--small form-count-title d-flex justify-content-between collapsed"
                                ...
                                <span class="form-accordion-title">APPLICATION FORM FOR EMPLOYMENT OF ARCHITECT</span><span
                                    class="accordion-icon"></span>
                            </a>
                        </div>
                        <div class="m-portlet__body collapse" id="form_1" data-parent="#accordion">
            ...
            <div class="m-portlet m-portlet--compact form-accordion m-portlet--forms-compact">
                <div class="d-flex justify-content-between align-items-center form-steps-toplinks">
                    <a class="btn--unstyled section-title section-title--small form-count-title d-flex justify-content-between collapsed"
                        ...
                        <span class="form-accordion-title">EMPANELMENT OF ARCHITECT/CONSULTANT WITH MHADA</span><span
                            class="accordion-icon"></span>
                    </a>
                </div>
                ...
                <div class="m-portlet__body m-portlet__body--spaced collapse" id="form_3" data-parent="#accordion">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="" name="staff_total" class="form-control form-control--custom m-input"
            ...
            <div class="m-portlet m-portlet--compact form-accordion m-portlet--forms-compact">
                ...
                <div class="m-portlet__body m-portlet__body--spaced m-portlet__body--table collapse" id="form_4"
            ...
            <div class="m-portlet m-portlet--compact form-accordion m-portlet--forms-compact">
                ...
                <div class="m-portlet__body m-portlet__body--spaced m-portlet__body--table collapse" id="form_5"
                    data-parent="#accordion">
                    <div class="">
                        <div class="table-responsive">
                            <table id="table-form-4" class="table table--box-input imp_projects">
            ...
            <div class="m-portlet m-portlet--compact form-accordion m-portlet--forms-compact">
                ...
                <div class="m-portlet__body m-portlet__body--spaced m-portlet__body--table collapse" id="form_6"
                    data-parent="#accordion">
                    <div class="">
                        <div class="table-responsive">
                            <table id="table-form-4" class="table table--box-input imp_projects">
                                ...
                                <tbody>
                                    ...
                                    @for($j=0;$j<(1+$k);$j++) <tr class="cloneme">
                                        ...
                                        <td><input name="year_of_qualification[]" placeholder="Year of Qualification"
        ...
        <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit" style="padding-left: 15px; padding-right: 15px;">
