...
<div class="form-group m-form__group row">
    ...
    <div class="col-sm-4 offset-sm-1 form-group">
        ...
        <input type="text" id="" name="pay_order_no" class="form-control form-control--custom m-input" value="{{$application->fee_payment_details!=""?$application->fee_payment_details->pay_order_no:""}}">
