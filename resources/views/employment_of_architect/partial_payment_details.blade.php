...
<div class="form-group m-form__group row">
    ...
    <div class="col-sm-4 form-group">
        <label class="col-form-label" for="">Pay Order No<span class="star">*</span></label>
    ...
    <div class="col-sm-4 form-group">
        <label class="col-form-label" for="">Bank Name<span class="star">*</span></label>
    ...
    <div class="col-sm-4 form-group">
        <label class="col-form-label" for="">Branch Name<span class="star">*</span></label>
    ...
    <div class="col-sm-4 form-group">
        <label class="col-form-label" for="">Payment Date<span class="star">*</span></label>
...
<div class="form-group m-form__group row">
    ...
    <div class="col-sm-4 form-group">
        <label class="col-form-label" for="">Receipt Date<span class="star">*</span></label>
