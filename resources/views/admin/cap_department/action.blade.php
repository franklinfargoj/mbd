...
<li id="cap-actions" class="collapse show">
    <ul class="list-unstyled">
        <li class="m-menu__item m-menu__item--submenu {{($route=='cap.view_application')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu {{($route=='cap.society_EE_documents')?'m-menu__item--active':''}}">
