                        ...
                        <div class="col">
                            <div class="form-group m-form__group">
                                <div class="btn-list">
                                    ...
                                    <button type="reset" onclick="window.location.href='{{ url("/cap") }}'" class="btn m-btn--pill m-btn--custom btn-metal">Reset</button>
                                </div>
                            </div>
                        </div>
                    </form>
