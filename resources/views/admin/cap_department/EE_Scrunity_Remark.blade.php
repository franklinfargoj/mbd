                                ...
                                <div class="col-sm-6 field-col">
                                    <div class="d-flex">
                                        ...
                                        <span class="field-value">
                                            {{(isset($eeScrutinyData->application_no) ? $eeScrutinyData->application_no
                                            : '')}}</span>
                                    </div>
                                </div>
                                <div class="col-sm-6 field-col">
                                ...
                                <div class="col-sm-6 field-col">
                                    <div class="d-flex">
                                        ...
                                        <span class="field-value">{{(isset($eeScrutinyData->eeApplicationSociety->name_of_architect)
                                            ? $eeScrutinyData->eeApplicationSociety->name_of_architect : '')}}</span>
                                    </div>
                                </div>
                                <div class="col-sm-6 field-col">
                                    <div class="d-flex">
                                        ...
                                        <span class="field-value">{{(isset($eeScrutinyData->eeApplicationSociety->architect_mobile_no)
                                            ? $eeScrutinyData->eeApplicationSociety->architect_mobile_no : '')}}</span>
                                    </div>
                                </div>
                                <div class="col-sm-6 field-col">
                                    <div class="d-flex">
                                        ...
                                        <span class="field-value">{{(isset($eeScrutinyData->eeApplicationSociety->architect_address)
                                            ? $eeScrutinyData->eeApplicationSociety->architect_address : '')}}</span>
                                    </div>
                                </div>
                                <div class="col-sm-6 field-col">
                                    <div class="d-flex">
                                        ...
                                        <span class="field-value">{{(isset($eeScrutinyData->eeApplicationSociety->architect_telephone_no)
                                            ? $eeScrutinyData->eeApplicationSociety->architect_telephone_no : '')}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    @if(isset($data->EE_document_path))<a href="{{ config('commanConfig.storage_server').'/'.$data->EE_document_path }}" target="_blank"><img
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="m-radio m-radio--primary">
                                                            <input type="radio" name="tit_radio_{{$i}}" disabled
                                            ...
                                            <div class="col-sm-6">
                                                <div class="d-flex flex-column h-100 two-cols">
                                                    ...
                                                    <div class="mt-auto">
                                                        ...
                                                        <a href="{{ config('commanConfig.storage_server').'/'.$eeScrutinyData->eeNote->document_path }}" class="btn btn-primary" target="_blank"> Download
                                                        </a>
                                                        @else
