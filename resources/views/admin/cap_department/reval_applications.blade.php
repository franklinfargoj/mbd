...
<div class="col-md-12">
    ...
    <div class="m-subheader px-0 m-subheader--top">
        <div class="d-flex align-items-center">
            <h3 class="m-subheader__title m-subheader__title--separator">Applications for Revalidation Of Offer Letter</h3>
        ...
        <div class="m-portlet m-portlet--compact filter-wrap">
            <div class="row align-items-center row--filter">
                <div class="col-md-12">
                    <form role="form" class="row align-items-end mb-0" id="eeForm" method="get" action="{{ route('cap_applications.reval') }}">
                        <div class="col-md-2">
