...
<li class="m-menu__item" >
    <a href="{{route('dyce.index')}}" class="m-menu__link m-menu__toggle">
...
<li id="dyce-actions" class="collapse show">
    <ul class="list-unstyled">
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='dyce.view_application')?'m-menu__item--active':''}}">
            <a class="m-menu__link m-menu__toggle" title="View Application" href="{{ route('dyce.view_application', encrypt($ol_application->id)) }}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='dyce.society_EE_documents')?'m-menu__item--active':''}}">
            <a class="m-menu__link m-menu__toggle" title="Society & EE Documents" href="{{route('dyce.society_EE_documents',encrypt($ol_application->id))}}">
                <span class="sidebar-icon sidebar-menu-icon--level-1">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='dyce.EE_Scrutiny_Remark')?'m-menu__item--active':''}}">
            <a class="m-menu__link m-menu__toggle" title="EE Scrutiny & Remarks" href="{{route('dyce.EE_Scrutiny_Remark',encrypt($ol_application->id))}}">
                <span class="sidebar-icon sidebar-menu-icon--level-1">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='dyce.scrutiny_remark')?'m-menu__item--active':''}}">
            <a class="m-menu__link m-menu__toggle" title="DyCE Scrutiny & Remarks" href="{{route('dyce.scrutiny_remark',encrypt($ol_application->id))}}">
                <span class="sidebar-icon sidebar-menu-icon--level-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 510 510">
                        <path fill="#fff" d="M0 387.6v96.9h96.9l280.5-283.05-96.9-96.9L0 387.6zm451.35-260.1c10.2-10.2 10.2-25.5 0-35.7L392.7 33.149c-10.2-10.2-25.5-10.2-35.7 0l-45.9 45.9 96.9 96.9 43.35-48.449zm-221.85 306l-51 51H510v-51H229.5z"/>
                    </svg>
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='dyce.forward_application')?'m-menu__item--active':''}}">
            <a class="m-menu__link m-menu__toggle" title="Forward Application" href="{{route('dyce.forward_application',encrypt($ol_application->id))}}">
                <span class="sidebar-icon sidebar-menu-icon--level-1">
