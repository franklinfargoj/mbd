...
<a title="scrutiny_remark" href="{{ route('dyce.scrutiny_remark') }}">Scrutiny & Remarks</a>
@if(!$request->update_status && $dyce_application_data->olApplicationStatusForLoginListing[0]->status_id == config('commanConfig.applicationStatus.in_process'))
