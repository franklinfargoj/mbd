                                                        ...
                                                        <tbody>
                                                             ...
                                                             @foreach($eeScrutinyData->relocationQuetions as $data) 
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <label class="m-radio m-radio--primary">
                                                                            <input type="radio" name="rg_radio_{{$i}}" disabled {{(isset($data->relocationQuetions) && $data->relocationQuetions->answer == '1') ? 'checked' : ''}}>
                                                                            <span></span>
                                                                        </label>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <textarea class="form-control form-control--custom form-control--textarea" disabled
                                                                            name="remark-one" id="remark-one">{{ isset($data->relocationQuetions) ? $data->relocationQuetions->remark : ''}}</textarea>
                                                                    </td>
                                                                </tr>
                                                                <?php $i++; ?>
                                                            @endforeach
