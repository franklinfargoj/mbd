            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        <input type="text" id="sr_no" name="sr_no" class="form-control m-input" value="{{ old('sr_no') }}">
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" id="village_name" name="village_name" class="form-control m-input"  value="{{ old('village_name') }}">
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" id="land_address" name="land_address" class="form-control m-input"  value="{{ old('land_address') }}">
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" id="taluka" name="taluka" class="form-control" class="form-control m-input"  value="{{ old('taluka') }}">
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" id="total_area" name="total_area" class="form-control m-input"  value="{{ old('total_area') }}">
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="date" id="possession_date" name="possession_date" class="form-control" class="form-control m-input"  value="{{ old('possession_date') }}">
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <textarea id="remark" name="remark" class="form-control m-input">{{ old('remark') }}</textarea>
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" id="land_cost" name="land_cost" class="form-control" class="form-control m-input"  value="{{ old('land_cost') }}">
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" id="property_card" name="property_card" class="form-control" class="form-control m-input"  value="{{ old('property_card') }}">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6 form-group extract_upload" style="display: none">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="file" id="extract" name="extract" class="form-control" class="form-control m-input"  value="{{ old('extract') }}">
