            ...
            <div class="m-portlet__body m-portlet__body--spaced">
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        <input type="text" id="sr_no" name="sr_no" class="form-control form-control--custom m-input" value="{{ $arrData['village_data']['sr_no'] }}">
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" id="land_cost" name="land_cost" class="form-control form-control--custom" class="form-control form-control--custom m-input"  value="{{ $arrData['village_data']['land_cost'] }}">
                ...
                <div class="form-group m-form__group row align-items-center">
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" id="property_card" name="property_card" class="form-control form-control--custom" class="form-control form-control--custom m-input"  value="{{ $arrData['village_data']['property_card'] }}">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6 form-group extract_upload" style="display: none">
                        ...
                        <div class="custom-file">
                            <input type="file" id="extract" name="extract" class="custom-file-input">{{ $arrData['village_data']['extract_file_name'] }}
