                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <div class="col-md-8 @if($errors->has('department_name')) has-error @endif">
                                                          <div class="input-icon right">
                                                              <input type="text" name="department_name" id="department_name" class="form-control" value="{{old('department_name')}}">
                                                    ...
                                                    <div class="mt-checkbox-inline col-md-8  @if($errors->has('board_id')) has-error @endif">
                                                        @foreach($boards as $val)
                                                          <label class="mt-checkbox">
                                                            <input type="checkbox" name="board_id[]" id="board{{ $val->id }}" value="{{ $val->id }}"> {{ $val->board_name }}
                                                            <span></span>
                                                          </label>
                                                        @endforeach
