...
@section('content')
    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        <form role="form" id="prePostSchedule" method="post" files="true" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="{{route('fix_schedule.store')}}">
            @csrf
            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6 form-group">
                        ...
                        <input type="text" id="case_year" name="case_year" class="form-control m-input" value="{{ $arrData['schedule_hearing_data']->case_year }}" readonly>
                        <span class="help-block">{{$errors->first('case_year')}}</span>
                    </div>
                    <div class="col-lg-6 form-group">
                        <label class="col-form-label" for="case_number">Case Number:</label>
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" id="case_number" name="case_number" class="form-control m-input"  value="{{ $arrData['schedule_hearing_data']->case_number }}" readonly>
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" id="appellant_name" name="appellant_name" class="form-control m-input"  value="{{ $arrData['schedule_hearing_data']->applicant_name }}" readonly>
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" id="respondent_name" name="respondent_name" class="form-control m-input"  value="{{ $arrData['schedule_hearing_data']->respondent_name }}" readonly>
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" id="first_hearing_date" name="first_hearing_date" class="form-control" class="form-control m-input"  value="{{ $arrData['schedule_hearing_data']->hearingSchedule->preceding_date }}" readonly>
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" id="preceding_officer_name" name="preceding_officer_name" class="form-control m-input"  value="{{ $arrData['schedule_hearing_data']->preceding_officer_name }}" readonly>
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" id="date" name="date" class="form-control m_datepicker" class="form-control m-input"  value="{{ old('date') }}">
