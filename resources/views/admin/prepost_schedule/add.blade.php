                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                        ...
                                        <div class="col-md-9 col-md-offset-2">
                                            <div class="radio-list">
                                                <label class="radio-inline">
                                                    <input type="radio" name="pre_post_status" value="1">Prepone</label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="pre_post_status" value="0" checked>Postpone</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" id="case_year" name="case_year" class="form-control disabled_input"  value="{{ $arrData['schedule_hearing_data']->case_year }}" readonly />
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" id="case_number" name="case_number" class="form-control disabled_input"  value="{{ $arrData['schedule_hearing_data']->case_number }}" readonly  />
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" id="respondent_name" name="respondent_name" class="form-control disabled_input"  value="{{ $arrData['schedule_hearing_data']->respondent_name }}" readonly  />
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" id="first_hearing_date" name="first_hearing_date" class="form-control disabled_input" value="{{ $arrData['schedule_hearing_data']->hearingSchedule->preceding_date }}" readonly/>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" id="preceding_officer_name" name="preceding_officer_name" class="form-control disabled_input"  value="{{ $arrData['schedule_hearing_data']->preceding_officer_name }}" readonly />
