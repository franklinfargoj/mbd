...
<div class="col-md-12">
    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        <form id="createHearingSchedule"  role="form" method="post" files="true" class="m-form m-form--rows m-form--label-align-right" action="{{route('schedule_hearing.store')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    <div class="col-lg-6 form-group">
                        ...
                        <input type="text" id="preceding_officer_name" name="preceding_officer_name" class="form-control form-control--custom m-input" value="{{ $arrData['hearing']->preceding_officer_name }}" readonly>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" id="preceding_number" name="preceding_number" class="form-control form-control--custom m-input"  value="{{ old('preceding_number') }}">
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" id="applicant_name" name="applicant_name" class="form-control form-control--custom m-input"  value="{{ $arrData['hearing']->applicant_name }}" readonly>
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" id="preceding_date" name="preceding_date" class="form-control form-control--custom m_datepicker" class="form-control m-input"  value="{{ old('preceding_date') }}">
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" id="preceding_time" name="preceding_time" class="form-control form-control--custom m-input"  value="{{ old('preceding_time') }}">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6 form-group">
                        <label class="col-form-label" for="update_supporting_documents">Update Supporting Documents:</label>
                            <div class="custom-file">
                                <input type="file" id="update_supporting_documents" name="file[update_supporting_documents]" class="custom-file-input">
