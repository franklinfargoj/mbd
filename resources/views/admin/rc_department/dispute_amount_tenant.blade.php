...
@section('content')
    <div class="container-fluid">
        ...
        <div class="m-portlet m-portlet--mobile m-portlet--forms-view">
            <form method="post" action="{{route('payment_dispute_tenant')}}">
                {{ csrf_field() }}
                ...
                <input type="text" name="trans_bill_generate_id" value="{{$bill->id}}" hidden>
                <div class="m-portlet__body m-portlet__body--spaced">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-sm-4 offset-sm-1 form-group">
                            ...
                            <input type="text" name="service_charge_balance" class="form-control form-control--custom m-input" value="{{$bill->service_charge_balance}}" readonly>
                            <span class="help-block"></span>
                        </div>
                    ...
                    <div class="form-group m-form__group row">
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" name="arrear_balance" class="form-control form-control--custom m-input" value="{{$bill->arrear_balance}}" readonly>
                            <span class="help-block"></span>
                        </div>
                        <div class="col-sm-4 offset-sm-1 form-group">
                            <label class="col-form-label" for="arrear_interest_balance">Arrear Interest Balance:</label>
                            <input type="text" name="arrear_interest_balance" class="form-control form-control--custom m-input" value="{{$bill->arrear_interest_balance}}" readonly>
                            <span class="help-block"></span>
                        </div>
