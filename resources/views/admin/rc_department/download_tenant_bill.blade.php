...
@php
    $total_service = $data['TransBillGenerate']->service_charges->water_charges + $data['TransBillGenerate']->service_charges->electric_city_charge + $data['TransBillGenerate']->service_charges->pump_man_and_repair_charges + $data['TransBillGenerate']->service_charges->external_expender_charge + $data['TransBillGenerate']->service_charges->administrative_charge +$data['TransBillGenerate']->service_charges->property_tax+ $data['TransBillGenerate']->service_charges->lease_rent + $data['TransBillGenerate']->service_charges->na_assessment + $data['TransBillGenerate']->service_charges->other;
...
<div>
        ...
        <tr>
            ...
            <td style="width: 360px;">
                <table style="font-size: 19px;">
                    <tr>
                        <td style="line-height: 20px;">Consumer No : TN-{{$data['consumer_number']}}</td>
                    </tr>
                    <tr>
                        <td style="line-height: 20px;">Society Name : @if(!empty($data['society'])){{$data['society']->society_name}}@endif</td>
                    </tr>
                    <tr>
                        <td style="line-height: 20px;">Bill No : {{$data['TransBillGenerate']->bill_number}}</td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            ...
            <td valign="top" style="background-color: #FFEFD5; padding: 5px;">
                <table>
                    <tbody>
                    <tr>
                        <td valign="top" style="font-weight: bold;">Bill Period :  {{date('1-M-Y', strtotime($data['TransBillGenerate']->bill_from ))}} to {{date('d-M-Y',strtotime($data['TransBillGenerate']->bill_to))}} </td>
                        <td valign="top" style="text-align: center;"></td>
                    </tr>
                    </tbody>
                </table>
        ...
        <tr>
            <td valign="top" style="background-color: #FFEFD5; padding: 5px;">
                <table>
                    <tbody>
                    <tr>
                        <td valign="top" style="font-weight: bold;">Amount : {{$data['TransBillGenerate']->total_bill}}</td>
                        <td valign="top" style="text-align: center;"></td>
                    </tr>
                    </tbody>
                </table>
    ...
    {{--<div style="border: 1px solid #000; padding: 5px; margin-top: 30px;background-color: lightblue;"><h3 style="text-align: center;">Bill Summary - {{date("M", strtotime("2001-" . $data['month'] . "-01"))}}, {{$data['year']}}</h3></div>--}}
    <table style="width: 100%; border-collapse: collapse; margin-top: 15px;">
        <thead>
        <tr>
            <th valign="top" style=" padding: 10px 5px; width: 40%;background-color: lightblue;">Bill Title - {{date("M", strtotime("2001-" . $data['month'] . "-01"))}}</th>
        ...
        <tr>
            ...
            <td valign="top" style=" padding: 5px;text-align: center; background-color: #f1f3f4;">{{$data['TransBillGenerate']->service_charges->water_charges}}</td>
        </tr>
        <tr>
            <td valign="top" style=" padding: 5px; background-color: #f1f3f4;">Electric City Charge</td>
            <td valign="top" style=" padding: 5px;text-align: center; background-color: #f1f3f4;">{{$data['TransBillGenerate']->service_charges->electric_city_charge}}</td>
        </tr>
        <tr>
            <td valign="top" style=" padding: 5px; background-color: #f1f3f4;">Pump Man & Repair Charges</td>
            <td valign="top" style=" padding: 5px;text-align: center; background-color: #f1f3f4;">{{$data['TransBillGenerate']->service_charges->pump_man_and_repair_charges}}</td>
        </tr>
        <tr>
            <td valign="top" style=" padding: 5px; background-color: #f1f3f4;">External Expenditure Charge</td>
            <td valign="top" style=" padding: 5px;text-align: center; background-color: #f1f3f4;">{{$data['TransBillGenerate']->service_charges->external_expender_charge}}</td>
        </tr>
        <tr>
            <td valign="top" style=" padding: 5px; background-color: #f1f3f4;">Administrative Charge</td>
            <td valign="top" style=" padding: 5px;text-align: center; background-color: #f1f3f4;">{{$data['TransBillGenerate']->service_charges->administrative_charge}}</td>
        </tr>
        <tr>
            <td valign="top" style=" padding: 5px; background-color: #f1f3f4;">Lease Rent</td>
            <td valign="top" style=" padding: 5px;text-align: center; background-color: #f1f3f4;">{{$data['TransBillGenerate']->service_charges->lease_rent}}</td>
        </tr>
        <tr>
            <td valign="top" style=" padding: 5px; background-color: #f1f3f4;">N.A.Assessment</td>
            <td valign="top" style=" padding: 5px;text-align: center; background-color: #f1f3f4;">{{$data['TransBillGenerate']->service_charges->na_assessment}}</td>
        </tr>
        <tr>
            <td valign="top" style=" padding: 5px; background-color: #f1f3f4;">Property Tax</td>
            <td valign="top" style=" padding: 5px;text-align: center; background-color: #f1f3f4;">{{$data['TransBillGenerate']->service_charges->property_tax==null?'0.00':$data['TransBillGenerate']->service_charges->property_tax}}</td>
        </tr>
        <tr>
            <td valign="top" style=" padding: 5px; background-color: #f1f3f4;">Other</td>
            <td valign="top" style=" padding: 5px;text-align: center; background-color: #f1f3f4;">{{$data['TransBillGenerate']->service_charges->other}}</td>
        </tr>
        <tr>
    ...
    @else
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 15px;">
            ...
            <tr>
                {{-- <td valign="top" style="background-color: #f1f3f4; padding: 5px; text-align:center;">{{$data['lastBill']->bill_year}}</td>
               <td valign="top" style="background-color: #f1f3f4; padding: 5px; text-align:center;">{{date("M", strtotime("2001-" . $data['lastBill']->bill_month . "-01"))}}</td>
               <td valign="top" style="background-color: #f1f3f4; padding: 5px; text-align:center;">{{$data['lastBill']->arrear_balance }}</td>
               <td valign="top" style="background-color: #f1f3f4; padding: 5px; text-align:center;">{{$data['lastBill']->arrear_interest_balance }}</td> --}}
                <td valign="top" style="background-color: #f1f3f4; padding: 5px; text-align:center;">{{$data['lastBill']->bill_year}}</td>
                <td valign="top" style="background-color: #f1f3f4; padding: 5px; text-align:center;">{{date("M", strtotime("2001-" . $data['lastBill']->bill_month . "-01"))}}</td>
                <td valign="top" style="background-color: #f1f3f4; padding: 5px; text-align:center;">{{$data['TransBillGenerate']->prev_arrear_balance }}</td>
                <td valign="top" style="background-color: #f1f3f4; padding: 5px; text-align:center;">{{$data['TransBillGenerate']->prev_arrear_interest_balance }}</td>
            </tr>
            <tr>
                <td valign="top" style="background-color: #f1f3f4; padding: 5px; text-align: right; font-weight: bold;" colspan="2">Total</td>
                <td valign="top" style="background-color: #f1f3f4; padding: 5px; text-align:center; font-weight: bold;">{{$total}}</td>
    ...
    <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
        ...
        <tr>
            ...
            <td valign="top" style="background-color: #f1f3f4; padding: 5px; text-align: center; font-weight: bold;">{{ceil($data['TransBillGenerate']->monthly_bill+$data['TransBillGenerate']->prev_service_charge_balance+$data['TransBillGenerate']->prev_arrear_balance+$data['TransBillGenerate']->prev_arrear_interest_balance-$data['TransBillGenerate']->prev_credit)}}</td>
        </tr>
        <tr>
            <td valign="top" style="background-color: #f1f3f4; padding: 5px; text-align: right; font-weight: bold;">Bill Amount After due date</td>
            <td valign="top" style="background-color: #f1f3f4; padding: 5px; text-align: center; font-weight: bold;">{{ceil($data['TransBillGenerate']->total_service_after_due+$data['TransBillGenerate']->prev_service_charge_balance+$data['TransBillGenerate']->prev_arrear_balance+$data['TransBillGenerate']->prev_arrear_interest_balance-$data['TransBillGenerate']->prev_credit)}}</td>
        </tr>
        </tbody>
    </table>
</div>
