...
<div class="col-md-12">
    ...
    <div class="m-subheader px-0 m-subheader--top">
        <div class="d-flex align-items-center" id="search_box">
            <h3 class="m-subheader__title">Calculation - {{$society->society_name}} - {{$tenant->first_name}} -
                {{$tenant->flat_no}}</h3>
    ...
    <div class="m-portlet m-portlet--forms-view">
                    ...
                    <form method="post" enctype='multipart/form-data' action="{{route('create_arrear_calculation')}}">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-4">
                                <div class="form-group m-form__group">
                                    <select class="form-control m-bootstrap-select m_selectpicker form-control--custom m-input"
                                        id="bill_year" name="year" required>
                                        <option value="" style="font-weight: normal;">Select Year</option>
                                        <option value="<?php echo  date('Y');?>" style="font-weight: normal;">
                                            <?php echo  date('Y'); ?>
                                        </option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group m-form__group">
                                    <select class="form-control m-bootstrap-select m_selectpicker form-control--custom m-input"
                                        id="bill_month" name="month" required>
                        ...
                        <div class="row align-items-center" style="margin-bottom: 1rem;">
                            <div class="col-md-4">
                                <div class="form-group m-form__group">
                                    <select class="form-control m-bootstrap-select m_selectpicker form-control--custom m-input ior"
                                        id="ior_year" name="oir_year" required>
                                        <option value="" style="font-weight: normal;">Select Year</option>
                                        <option value="<?php echo  date('Y');?>" style="font-weight: normal;">
                                            <?php echo  date('Y'); ?>
                                        </option>
                                        ...
                                        <option value="<?php echo date(" Y",strtotime("-2 year")); ?>"
                                            style="font-weight: normal;">
                                            <?php echo date("Y",strtotime("-2 year")); ?>
                                        </option>
                                        <option value="<?php echo date(" Y",strtotime("-3 year")); ?>"
                                            style="font-weight: normal;">
                                            <?php echo date("Y",strtotime("-3 year")); ?>
                                        </option>
                                        <option value="<?php echo date(" Y",strtotime("-4 year")); ?>"
                                            style="font-weight: normal;">
                                            <?php echo date("Y",strtotime("-4 year")); ?>
                                        </option>
                                        <option value="<?php echo date(" Y",strtotime("-5 year")); ?>"
                                            style="font-weight: normal;">
                                            <?php echo date("Y",strtotime("-5 year")); ?>
                                        </option>
                                        <option value="<?php echo date(" Y",strtotime("-6 year")); ?>"
                                            style="font-weight: normal;">
                                            <?php echo date("Y",strtotime("-6 year")); ?>
                                        </option>
                                        <option value="<?php echo date(" Y",strtotime("-7 year")); ?>"
                                            style="font-weight: normal;">
                                            <?php echo date("Y",strtotime("-7 year")); ?>
                                        </option>
                                        <option value="<?php echo date(" Y",strtotime("-8 year")); ?>"
                                            style="font-weight: normal;">
                                            <?php echo date("Y",strtotime("-8 year")); ?>
                                        </option>
                                        <option value="<?php echo date(" Y",strtotime("-9 year")); ?>"
                                            style="font-weight: normal;">
                                            <?php echo date("Y",strtotime("-9 year")); ?>
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group m-form__group">
                                    <select class="form-control m-bootstrap-select m_selectpicker form-control--custom m-input ior"
                                        id="ior_month" name="oir_month" required>
                                        <option value="" style="font-weight: normal;">Select Month</option>
                                        <option value="1" style="font-weight: normal;">Jan</option>
                                        <option value="2" style="font-weight: normal;">Feb</option>
                                        <option value="3" style="font-weight: normal;">Mar</option>
                        ...
                        <div class="row align-items-center" style="margin-bottom: 1rem;">
                            ...
                            <input type="text" id="difference_amount" name="difference_amount" value="<?php echo $rate_card->revise_rate - $rate_card->old_rate; ?>"
                                hidden required>

                            <div class="col-md-4">
                                <!-- Formula = Revise Rate - Old Rate -->
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center" style="margin-bottom: 1rem;">
                            <div class="col-md-4">
                                <div class="form-group m-form__group">
                                    <select class="form-control m-bootstrap-select m_selectpicker form-control--custom m-input ida"
                                        id="ida_year" name="ida_year" required>
                                        <option value="" style="font-weight: normal;">Select Year</option>
                                        <option value="<?php echo  date('Y');?>" style="font-weight: normal;">
                                            <?php echo  date('Y'); ?>
                                        </option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group m-form__group">
                                    <select class="form-control m-bootstrap-select m_selectpicker form-control--custom m-input ida"
                                        id="ida_month" name="ida_month" required>
                                        <option value="" style="font-weight: normal;">Select Month</option>
                                        <option value="1" style="font-weight: normal;">Jan</option>
                                        <option value="2" style="font-weight: normal;">Feb</option>
                                        <option value="3" style="font-weight: normal;">Mar</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group m-form__group">
                                    ...
                                    <input type="text" id="difference_intrest_amount" name="difference_intrest_amount"
                                        hidden required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center" style="margin-bottom: 1rem;">
                            <div class="col-md-9">
                                <div class="form-group m-form__group building_list">
                                    ...
                                    <label class="radio-inline" style="margin-right: 1rem;"> <input type="radio" name="payment_status"
                        ...
                        <div class="row align-items-center" style="margin-bottom: 1rem;">
                            ...
                            <div class="col-md-8">
                                <!-- Formula = old rate + old Intrest amount + Diffrence Amount + Diffrence Intrest amount -->
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center mb-0">
                            <div class="col-md-9">
                                <div class="form-group m-form__group">
                                    <input type="submit" class="btn m-btn--pill m-btn--custom btn-primary" name="save"
                                        value="Save">
    ...
    <div class="m-portlet m-portlet--forms-view">
        <div class="portlet-title">
            <div class="caption">
                <div class="tools">
                    <h3 class="m-subheader__title--hint" style="margin-left: 0;">Monthly details of -
                        {{$tenant->first_name}} - {{$tenant->flat_no}}</h3>
                </div>
            </div>
    ...
    <script>
        ...
        function total_amount() {
            ...
            var total = (parseFloat(old_rate * months1) + parseFloat(old_intrest_amount) + parseFloat(rate_diff *
                months1) + parseFloat(intrest_on_difference)).toFixed(2);
