...
<div class="col-md-12">
    <div class="m-subheader px-0 m-subheader--top">
        <div class="d-flex align-items-center">
            ...
            {{ Breadcrumbs::render('lease_edit', $id, $society_id) }}
            <div class="ml-auto btn-list">
                <a href="{{ url('/lease_detail/'.$society_id. '/'.$village_id) }}" class="btn btn-link"><i class="fa fa-long-arrow-left" style="padding-right: 8px;"></i>Back</a>
            </div>
        </div>
    </div>
    <!-- END: Subheader -->
