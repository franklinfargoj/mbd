                ...
                <div class="m-portlet__body m-portlet__body--spaced">
                    ...
                    <div class="form-group m-form__group row">
                        <div class="col-lg-6 form-group">
                            ...
                            <div class="m-input-icon m-input-icon--right">
                                <input type="text" id="lease_start_date" name="lease_start_date" class="form-control form-control--custom m-input m_datepicker" readonly value="{{ old('lease_start_date') }}">
                    ...
                    <div class="form-group m-form__group row">
                        <div class="col-lg-6 form-group">
                            ...
                            <div class="m-input-icon m-input-icon--right">
                                <select class="form-control m-bootstrap-select m_selectpicker form-control--custom m-input" id="lease_rent_start_month" name="lease_rent_start_month">
                    ...
                    <div class="form-group m-form__group row">
                        <div class="col-lg-6 form-group">
                            ...
                            <div class="m-input-icon m-input-icon--right">
                                <input type="text" id="lease_renewal_date" name="lease_renewal_date" class="form-control form-control--custom m-input m_datepicker" readonly value="{{ old('lease_renewal_datedate_on_service_tax') }}">
                    ...
                    <div class="form-group m-form__group row">
                        <div class="col-lg-6 form-group">
                            ...
                            <div class="m-input-icon m-input-icon--right">
                                <input type="text" id="rent_per_renewed_lease" name="rent_per_renewed_lease" class="form-control form-control--custom m-input"  value="{{ old('rent_per_renewed_lease') }}">
                        ...
                        <div class="col-lg-6 form-group">
                            ...
                            <div class="m-input-icon m-input-icon--right">
                                <input type="text" id="interest_per_renewed_lease_agreement" name="interest_per_renewed_lease_agreement" class="form-control form-control--custom m-input" value="{{ old('interest_per_renewed_lease_agreement') }}">
                    ...
                    <div class="form-group m-form__group row">
                        <div class="col-lg-6 form-group">
                            ...
                            <div class="m-input-icon m-input-icon--right">
                                <select class="form-control m-bootstrap-select m_selectpicker form-control--custom m-input" id="month_rent_per_renewed_lease" name="month_rent_per_renewed_lease">
                                    @foreach($arrData['month_data'] as $month)
                                        <option value="{{ $month->id  }}" {{ (date('n') == $month->id) ? "selected" : "" }}>{{ $month->month_name }}</option>
                                    @endforeach
                                </select>
