...
@section('content')
    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        <form id="addLeaseDetail" role="form" method="post" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="{{route('lease_detail.store')}}">
            @csrf
