    ...
    <div class="m-portlet m-portlet--mobile m_panel">
        <div class="m-portlet__body m-portlet__body--table main_panel">
            <table class="table mb-0">
                ...
                <tbody>
                    <?php $i=0; ?>
                    @foreach($societyDocuments[0]->societyOcDocuments as $data)
                    <tr>
                        <td>{{$i+1}}</td>
...
@if($societyDocuments[0]->documentCommentsforOc) 
<div class="col-md-12">
                    ...
                    <div class="remarks-suggestions table--box-input">
                        <div class="mt-3">
                            ...
                            <div class="@if($errors->has('society_documents_comment')) has-error @endif">
                                <textarea name="society_documents_comment" rows="5" cols="30" id="society_documents_comment" class="form-control form-control--custom" readonly>{{ $societyDocuments[0]->documentCommentsforOc->society_documents_comment }}</textarea>
