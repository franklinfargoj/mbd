...
<li id="co-actions" class="collapse show">
   <ul class="list-unstyled">
      <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{($route=='co.view_noc_cc_application')?'m-menu__item--active':''}}">
      ...
      <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{($route=='co.society_noc_cc_documents')?'m-menu__item--active':''}}">
      ...
      <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{($route=='co.noc_cc_scrutiny_remarks')?'m-menu__item--active':''}}">
      ...
      @endif
      <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{($route=='co.forward_noc_cc_application')?'m-menu__item--active':''}}">
