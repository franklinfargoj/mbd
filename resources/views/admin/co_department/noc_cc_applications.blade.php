...
<div class="col-md-12">
   ...
   <div class="m-subheader px-0 m-subheader--top">
      <div class="d-flex align-items-center">
         <h3 class="m-subheader__title m-subheader__title--separator">Application for NOC (CC)</h3>
         {{ Breadcrumbs::render('co_noc_cc') }}
      ...
      <div class="row--filter">
         <div class="col-md-12">
            <form role="form" id="noc_applications_form" method="get" class="form-group m-form__group row align-items-end mb-0"
               action="{{ route('co_applications.noc_cc') }}">
               <!--                                 <div class="col-md-3">
                  ...
                  <div class="col">
                     <div class="form-group m-form__group">
                        <div class="btn-list">
                           ...
                           <button type="reset" onclick="window.location.href='{{ url("/co_noc_applications") }}'" class="btn m-btn--pill m-btn--custom btn-metal">Reset</button>
                        </div>
                     </div>
                  </div>
               </div>
