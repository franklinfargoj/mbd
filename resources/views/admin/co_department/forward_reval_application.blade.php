...
<div class="custom-wrapper">
    <div class="col-md-12">
        <div class="d-flex">
            {{ Breadcrumbs::render('Forward_Reval_Application_co',$ol_application->id) }}
                                                            ...
                                                            <div class="portlet-body">
                                                                <div class="m-portlet__body m-portlet__body--table m-portlet__body--serial-no m-portlet__body--serial-no-pdf">
                                                                    ...
                                                                    <div class="remarks-suggestions">
                                                                        <form action="{{ route('co.forward_reval_application_data') }}"
                                                                                ...
                                                                                <div class="form-group m-form__group row mt-3 parent-data"
                                                                                    ...
                                                                                    <div class="col-lg-4 col-md-9 col-sm-12">
                                                                                        <select class="form-control m-bootstrap-select m_selectpicker form-control--custom m-input"
                                                                                            ...
                                                                                            @endforeach
                                                                                            @else
                                                                                            @foreach($arrData['get_forward_cap']
                                                                                            as $parent)
                                                                                            <option value="{{ $parent->user_id }}"
                                                                                                data-role="{{ $parent->role_id }}">{{
                                                                                                $parent->name
                                                                                                }} ({{
                                                                                                $arrData['cap_role_name']
                                                                                                }})</option>
                                                                                            @endforeach
                                                                                            @endif
                                                                                        </select>
