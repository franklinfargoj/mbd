...
<li id="co-actions" class="collapse show">
    <ul class="list-unstyled">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='common.view_society_EE_documents' || $route == 'view_multiple_document') ? 'm-menu__item--active':''}}"><a class="m-menu__link" title="Society & EE Documents" href="{{route('common.view_society_EE_documents',encrypt($ol_application->id))}}">
                <span class="sidebar-icon sidebar-menu-icon--level-1">
