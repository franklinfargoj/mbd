    ...
    <ul class="list-unstyled">
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='co.view_application')?'m-menu__item--active':''}}"><a class="m-menu__link m-menu__toggle" title="View Application"
            ...
            <span class="sidebar-icon sidebar-menu-icon--level-1">
                ...
                <span class="m-menu__link-text">View Application</span></a></li>

        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='co.society_EE_documents')?'m-menu__item--active':''}}"><a class="m-menu__link" title="Society & EE Documents" href="{{route('co.society_EE_documents',encrypt($ol_application->id))}}">
                <span class="sidebar-icon sidebar-menu-icon--level-1">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='co.EE_Scrutiny_Remark')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='co.scrutiny_remark')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='co.show_calculation_sheet')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='co.approve_offer_letter')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='co.download_cap_note')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='co.forward_application')?'m-menu__item--active':''}}">
