    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="leaseAgreement" action="{{ route('dyco.generateLeaseAgreement') }}" method="POST">
                @csrf 
                 <input type="hidden" name="oldLease" value="{{ isset($data->DraftGeneratedLease->document_path) ?  $data->DraftGeneratedLease->document_path : '' }}">
                    <input type="hidden" name="applicationId" value="{{ isset($data->id) ? $data->id : '' }}">
                     <textarea id="ckeditorText" name="leaseAgreement" style="display: none;">
                        <div style="" id="">
                            <div style="padding-left: 15px;">
                            @if(isset($leaseContent) && $leaseContent != '')
                                    {{$leaseContent}}
                            @else
