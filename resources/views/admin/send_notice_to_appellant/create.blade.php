...
@section('content')
    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        <form id="sendNoticeToAppellant" role="form" method="post" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="{{route('send_notice_to_appellant.store')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text"  class="form-control m-input"  value="{{ $arrData['hearing']->hearingSchedule->preceding_date }}" readonly>
                            <span class="help-block"></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="text" id="preceding_time" name="preceding_time" class="form-control m-input" value="{{$arrData['hearing']->hearingSchedule->preceding_time }}" readonly/>
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="file" id="upload_notice" name="upload_notice" class="form-control">
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <textarea id="comment" name="comment" class="form-control m-input">{{ old('comment') }}</textarea>
