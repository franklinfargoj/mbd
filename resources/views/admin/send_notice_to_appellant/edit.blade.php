            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="file" id="upload_notice" name="upload_notice" class="form-control">{{ $arrData['hearing']->hearingSendNoticeToAppellant[0]->upload_notice_filename }}
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <textarea id="comment" name="comment" class="form-control m-input">{{ $arrData['hearing']->hearingSendNoticeToAppellant[0]->comment }}</textarea>
