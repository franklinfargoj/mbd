...
@endphp
    ...
    <div class="col-md-12">
                            ...
                            <span class="m-portlet__head-icon m--hide">
                                ...
                                $boardVal->board_name }}</option>
                                    ...
                                    <div class="col-sm-4 offset-sm-1 form-group">
                                        ...
                                        <select disabled class="form-control m-bootstrap-select m_selectpicker form-control--custom m-input" id="department"
                                                name="department">
                                            {{--<option value="">{{$forward_hearing_data['department_id']}}</option>--}}
                                            @foreach($arrData['department'] as $departmentVal)
                                                <option value="{{ $departmentVal->id }}" {{ $departmentVal->id == $forward_hearing_data['department_id'] ? 'selected':'' }}>{{
                                $departmentVal->department_name }}</option>
                                            @endforeach
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-sm-4 form-group">
                                        ...
                                        <select  disabled class="form-control m-bootstrap-select m_selectpicker form-control--custom m-input" id="user"
                                                name="user">
                                        </select>
        ...
        @section('datatablejs')
            ...
            var department_name = $("#department option:selected").html();
            var board_id = $("#board_id option:selected").val();
