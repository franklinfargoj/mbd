        ...
        <div class="col-md-12">
            ...
            <div class="portlet box purple">
                ...
                <div class="portlet-body form" style="display: block;">
                    <form id="forwardCase" role="form" method="post" class="form-horizontal" action="{{route('forward_case.update', $arrData['hearing']->hearingForwardCase[0]->id)}}">
                        @csrf
                            ...
                            <div>
                                    ...
                                    <div class="col-md-3 @if($errors->has('board')) has-error @endif">
                                        <select name="board" id="board_id" class="form-control">
                                            ...
                                            @foreach($arrData['board'] as $boardVal)
                                                <option value="{{ $boardVal->id }}" {{($boardVal->id == $arrData['hearing']->hearingForwardCase[0]->board_id) ?'selected':'' }}>{{ $boardVal->board_name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 @if($errors->has('department')) has-error @endif">
                                        <select name="department" id="department_id" class="form-control department">
