...
<li id="ree-actions" class="collapse show">
    <ul class="list-unstyled">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ree.view_reval_application')?'m-menu__item--active':''}}">
        ...
        @if(session()->get('role_name') != config('commanConfig.ree_junior'))
            <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ree.show_reval_calculation_sheet')?'m-menu__item--active':''}}"
                aria-haspopup="true">
                <a class="m-menu__link m-menu__toggle" title="View Calculation Sheet" href="{{url('reval_calculation_sheet_ree',$ol_application->id)}}">
                    <span class="sidebar-icon sidebar-menu-icon--level-1">
            ...
            @elseif($ol_application->model->ol_application_master->model == 'Sharing')
                <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ol_reval_sharing_calculation_sheet.show')?'m-menu__item--active':''}}"
                    aria-haspopup="true">
        ...
        config('commanConfig.applicationStatus.offer_letter_generation'))
            <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ree.generate_reval_offer_letter')?'m-menu__item--active':''}}"
                aria-haspopup="true">
                <a class="m-menu__link m-menu__toggle" title="Offer Letter" href="{{route('ree.generate_reval_offer_letter',$ol_application->id)}}">
                    <span class="sidebar-icon sidebar-menu-icon--level-1">
        ...
        config('commanConfig.applicationStatus.sent_to_society'))
            <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ree.approved_reval_offer_letter')?'m-menu__item--active':''}}"
                aria-haspopup="true">
                <a class="m-menu__link m-menu__toggle" title="Offer Letter" href="{{route('ree.approved_reval_offer_letter',$ol_application->id)}}">
                    <span class="sidebar-icon sidebar-menu-icon--level-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#fff">
                      <path d="M494.2 488V187c0-3.1-3.9-7-7.7-9.9L407.8 120V56.9c0-6.2-5.2-10.4-10.4-10.4h-89.7L262 13.2c-3.1-2.1-8.3-2.1-11.5 0l-45.7 33.3h-89.7c-6.2 0-10.4 5.2-10.4 10.4v62.4L25 177.2c-4.7 2.9-7.7 6.7-7.7 9.9v303c0 5.9 4.7 10 9.6 10.4h456.8c6.7-.1 10.5-5.3 10.5-12.5zm-19.8-282.3v263.6L302.3 331.5l172.1-125.8zm-7.7-18.3l-58.9 42.9v-86.2l58.9 43.3zM255.8 32.9l18.3 13.5h-36.7l18.4-13.5zM387 67.3v178.2l-131.2 95.6-131.2-95.6V67.3H387zM37.2 205.7l172.1 125.8L37.2 470.1V205.7zm67.6 25.4l-60.4-44 60.4-43.9v87.9zM55.9 480.6L226 343.7l23.5 17.2c4.5 3.4 7.9 3.4 12.5 0l23.5-17.2 171.1 136.9H55.9z"/>
                      <path d="M186.1 118.3h140.5v19.8H186.1zM186.1 181.8h140.5v19.8H186.1zM186.1 245.3h140.5v19.8H186.1z"/>
      ...
      <!--  @if($ol_application->cap_notes!="")
            ...
            <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{($route=='ree.download_reval_cap_note')?'m-menu__item--active':''}}"
                aria-haspopup="true">
                <a class="m-menu__link m-menu__toggle " title="CAP Notes" href="{{route('ree.download_reval_cap_note',$ol_application->id)}}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ree.forward_reval_application')?'m-menu__item--active':''}}"
            aria-haspopup="true">
