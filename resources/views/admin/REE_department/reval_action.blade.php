...
<li id="ree-actions" class="collapse show">
    <ul class="list-unstyled">
        ...
        @if(session()->get('role_name') != config('commanConfig.ree_junior'))
            <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{($route=='ree.show_reval_calculation_sheet')?'m-menu__item--active':''}}"
                aria-haspopup="true">
        ...
        config('commanConfig.applicationStatus.offer_letter_generation'))
            <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{($route=='ree.generate_reval_offer_letter')?'m-menu__item--active':''}}"
                aria-haspopup="true">
        ...
        config('commanConfig.applicationStatus.sent_to_society'))
            <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{($route=='ree.approved_reval_offer_letter')?'m-menu__item--active':''}}"
                aria-haspopup="true">
