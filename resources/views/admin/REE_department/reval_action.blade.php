...
<li id="ree-actions" class="collapse show">
    <ul class="list-unstyled">
        ...
        <li class="m-menu__item m-menu__item--submenu {{($route=='ree.view_application' || $route=='ree.view_reval_application')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu {{($route=='ree.dyce_scrutiny_remark')?'m-menu__item--active':''}}"
            aria-haspopup="true">
        ...
        <li class="m-menu__item m-menu__item--submenu {{($route=='ree.generate_offer_letter')?'m-menu__item--active':''}}"
            aria-haspopup="true">
        ...
        <li class="m-menu__item m-menu__item--submenu {{($route=='ree.forward_application')?'m-menu__item--active':''}}"
            aria-haspopup="true">
        ...
        <li class="m-menu__item m-menu__item--submenu {{($route=='ree.download_cap_note')?'m-menu__item--active':''}}"
            aria-haspopup="true">
