...
<li id="ree-actions" class="collapse show">
    <ul class="list-unstyled">
        ...
        <li class="m-menu__item m-menu__item--submenu {{($route=='ree.view_reval_application')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu {{($route=='ree.society_reval_documents')?'m-menu__item--active':''}}"
            aria-haspopup="true">
