                                    ...
                                    <form  role="form" method="POST"  action="{{ route('save_sharing_calculation_details') }}">
                                        ...
                                        <table class="table mb-0" style="padding-top: 10px;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <input type="text" class="total_area remaining_area infra_fee  form-control form-control--custom" name="area_of_tit_bit_plot" id="area_of_tit_bit_plot" value="{{ isset($calculationSheetDetails[0]->area_of_tit_bit_plot) ? $calculationSheetDetails[0]->area_of_tit_bit_plot : 0 }}"/>
                                                </td>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <input class="remaining_area infra_fee form-control form-control--custom" type="text"
                                                           name="permissible_carpet_area_coordinates" id="permissible_carpet_area_coordinates" value="{{ isset($calculationSheetDetails[0]->permissible_carpet_area_coordinates) ? $calculationSheetDetails[0]->permissible_carpet_area_coordinates : 0 }}"/>
                                    ...
                                    <form  role="form" method="POST"  action="{{ route('save_sharing_calculation_details') }}">
                                        ...
                                        <table class="table mb-0" style="padding-top: 10px;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <input class="form-control form-control--custom"  type="text"
                                                           name="rc_val" id="rc_val" value="{{ isset($calculationSheetDetails[0]->rc_val) ? $calculationSheetDetails[0]->rc_val : 0 }}"/>
                                    ...
                                    <form  role="form" method="POST"  action="{{ route('save_sharing_calculation_details') }}">
                                        ...
                                        <table class="table mb-0" style="padding-top: 10px;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <input class="infra_fee  form-control form-control--custom"  type="text"
                                                           name="existing_construction_area" id="existing_construction_area" value="{{ isset($calculationSheetDetails[0]->existing_construction_area) ? $calculationSheetDetails[0]->existing_construction_area : 0 }}"/>
