    ...
    <div style="" id="">
        ...
        {{  converNumberToWord(5120) }}
            ...
            <div style="line-height: 1.5;">
                ...
                <p style="text-indent: 25px; margin-top: 5px; margin-bottom: 5px;">Allotment of additional buildable area of <span style="font-weight: bold"> {{$calculationData->premiumCalculationSheet->remaining_area}} m<sup>2</sup> </span> (for residential use)[i.e. ___________ in the form of additional BUA +  ___________ m<sup>2</sup> in the form of balance built up area of layout (Pro-rata)] over and above {{($calculationData->premiumCalculationSheet->existing_construction_area ? $calculationData->premiumCalculationSheet->existing_construction_area : '')}} m<sup>2</sup> 
                    existing built up area.</p>
                <p style="text-indent: 25px; margin-top: 5px; margin-bottom: 5px;">
                The above allotment is on sub-divided plot as per layout admeasuring about <span style="font-weight: bold"> {{($calculationData->premiumCalculationSheet->area_of_​​subsistence_to_calculate ? $calculationData->premiumCalculationSheet->area_of_​​subsistence_to_calculate : '')}} m<sup>2</sup> </span> (i.e. _____________________ m<sup>2</sup> Lease Area +
