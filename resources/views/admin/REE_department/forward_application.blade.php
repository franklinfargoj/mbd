                    ...
                    <div class="m-portlet m-portlet--tabs m-portlet--bordered-semi mb-0">
                        <div class="portlet-body">
                            <div class="m-portlet__body m-portlet__body--table m-portlet__body--serial-no m-portlet__body--serial-no-pdf">
                                ...
                                <div class="remark-body">
                                    <div class="border-bottom pb-2">
                                        <span class="hint-text d-block font-weight-semi-bold">Remark by REE</span>
                                    </div>
                                    <div class="remarks-section">
                                        <div class="m-scrollable m-scroller ps ps--active-y remarks-section-container"
                                            data-scrollbar-shown="true" data-scrollable="true" data-max-height="200">
                                ...
                                <div class="remark-body">
                                    <div class="border-bottom pb-2">
                                        <span class="hint-text d-block font-weight-semi-bold">Remark by CO</span>
                                    </div>
                                    <div class="remarks-section">
                                        <div class="m-scrollable m-scroller ps ps--active-y remarks-section-container"
                                ...
                                <div class="remark-body">
                                    <div class="border-bottom pb-2">
                                        <span class="hint-text d-block font-weight-semi-bold">Remark by CAP</span>
                                    </div>
                                    <div class="remarks-section">
                                        <div class="m-scrollable m-scroller ps ps--active-y remarks-section-container"
                                            data-scrollbar-shown="true" data-scrollable="true">
                                ...
                                <div class="remark-body">
                                    <div class="border-bottom pb-2">
                                        <span class="hint-text d-block font-weight-semi-bold">Remark by VP</span>
                                    </div>
                                    <div class="remarks-section">
                                        <div class="m-scrollable m-scroller ps ps--active-y remarks-section-container"
                                            data-scrollbar-shown="true" data-scrollable="true">
                                        ...
                                        <div class="m-scrollable m-scroller ps ps--active-y remarks-section-container"
                                            ...
                                            <div class="remarks-section__data" style="display: none">
                                                ...
                                                <p class="remarks-section__data__row"><span>Description:</span><span>{{(isset($applicationData->dyceForwardLog->remark)
                                                        ? $applicationData->dyceForwardLog->remark : '')}}</span></ </div>
