...
<li class="m-menu__item" >
    <a href="{{route('ree_applications.index')}}" class="m-menu__link m-menu__toggle">
...
<li id="ree-actions" class="collapse show">
    <ul class="list-unstyled">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ree.view_application')?'m-menu__item--active':''}}">
            <a class="m-menu__link m-menu__toggle" title="View Application" href="{{ route('ree.view_application', encrypt($ol_application->id)) }}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ree.society_EE_documents')?'m-menu__item--active':''}}"
            aria-haspopup="true">
            <a class="m-menu__link m-menu__toggle" title="Society & EE Documents" href="{{route('ree.society_EE_documents',encrypt($ol_application->id))}}">
                <span class="sidebar-icon sidebar-menu-icon--level-1">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ree.dyce_scrutiny_remark')?'m-menu__item--active':''}}"
            aria-haspopup="true">
            <a class="m-menu__link m-menu__toggle" title="DyCE Scrutiny & Remarks" href="{{route('ree.dyce_scrutiny_remark',encrypt($ol_application->id))}}">
                <span class="sidebar-icon sidebar-menu-icon--level-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 510 510">
                        <path fill="#fff" d="M0 387.6v96.9h96.9l280.5-283.05-96.9-96.9L0 387.6zm451.35-260.1c10.2-10.2 10.2-25.5 0-35.7L392.7 33.149c-10.2-10.2-25.5-10.2-35.7 0l-45.9 45.9 96.9 96.9 43.35-48.449zm-221.85 306l-51 51H510v-51H229.5z"/>
                    </svg>
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ol_sharing_calculation_sheet.show' || $route=='ol_calculation_sheet.show' || $route=='ree.show_calculation_sheet')?'m-menu__item--active':''}}"
            aria-haspopup="true">
            <a class="m-menu__link m-menu__toggle" title="View Calculation Sheet" href="{{url('calculation_sheet_ree',encrypt($ol_application->id))}}">
                <span class="sidebar-icon sidebar-menu-icon--level-1">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ol_sharing_calculation_sheet.show')?'m-menu__item--active':''}}"
            aria-haspopup="true">
            <a class="m-menu__link m-menu__toggle" title="Prepare Calculation Sheet" href="{{url('ol_sharing_calculation_sheet',encrypt($ol_application->id))}}">
                <span class="sidebar-icon sidebar-menu-icon--level-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        <path fill="#fff" d="M81 0v469.702L121.607 512h268.786L431 469.702V0H81zm320 457.632L377.607 482H134.393L111 457.632V192.334h290v265.298zM180.503 162.334V95.875h150.994v66.459H180.503zm220.497 0h-39.503V65.875H150.503v96.459H111V30h290v132.334z"/>
                        <path fill="#fff" d="M151.33 287.78h30v30h-30zM211.11 228h30v30h-30zM211.11 287.78h30v30h-30zM270.89 228h30v30h-30zM270.89 287.78h30v30h-30zM330.67 228h30v30h-30zM151.33 228h30v30h-30zM151.33 347.56h30v30h-30zM151.33 407.33h30v30h-30zM330.67 287.78h30v30h-30zM211.11 347.56h30v30h-30zM270.89 347.56h30v30h-30zM211.11 407.33h30v30h-30zM270.89 407.33h30v30h-30zM330.67 347.56h30v89.78h-30z"/>
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ol_sharing_calculation_sheet.show')?'m-menu__item--active':''}}"
            aria-haspopup="true">
            <a class="m-menu__link m-menu__toggle" title="Prepare Calculation Sheet" href="{{url('ol_calculation_sheet',encrypt($ol_application->id))}}">
                <span class="sidebar-icon sidebar-menu-icon--level-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        <path fill="#fff" d="M81 0v469.702L121.607 512h268.786L431 469.702V0H81zm320 457.632L377.607 482H134.393L111 457.632V192.334h290v265.298zM180.503 162.334V95.875h150.994v66.459H180.503zm220.497 0h-39.503V65.875H150.503v96.459H111V30h290v132.334z"/>
                        <path fill="#fff" d="M151.33 287.78h30v30h-30zM211.11 228h30v30h-30zM211.11 287.78h30v30h-30zM270.89 228h30v30h-30zM270.89 287.78h30v30h-30zM330.67 228h30v30h-30zM151.33 228h30v30h-30zM151.33 347.56h30v30h-30zM151.33 407.33h30v30h-30zM330.67 287.78h30v30h-30zM211.11 347.56h30v30h-30zM270.89 347.56h30v30h-30zM211.11 407.33h30v30h-30zM270.89 407.33h30v30h-30zM330.67 347.56h30v89.78h-30z"/>
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ree.download_cap_note')?'m-menu__item--active':''}}"
            aria-haspopup="true">
            <a class="m-menu__link m-menu__toggle " title="CAP Notes" href="{{route('ree.download_cap_note',encrypt($ol_application->id))}}">
                <span class="sidebar-icon sidebar-menu-icon--level-1">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ree.forward_application')?'m-menu__item--active':''}}"
            aria-haspopup="true">
            <a class="m-menu__link m-menu__toggle " title="Forward Application" href="{{route('ree.forward_application',encrypt($ol_application->id))}}">
                <span class="sidebar-icon sidebar-menu-icon--level-1">
