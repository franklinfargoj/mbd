   ...
   <body>  
      <div class="m_portlet">
         <form action="{{route('ree.save_draft_consent_oc')}}" id="OfferLetterFRM" method="post" name="OfferLetterFRM">
            ...
            @if($content != "" && $status->status_id == config('commanConfig.applicationStatus.in_process')) 
            {{$content}} 
            @elseif($OcType == 'part_oc' && $status->status_id == config('commanConfig.applicationStatus.in_process'))
            ...
            @elseif($status->status_id == config('commanConfig.applicationStatus.OC_Approved')) 
              <div id="" style="font-size: 16px">
                <p><strong>मसुदा मान्यतेकरीता सादर</strong>
                    <br /> जा।क्र।/नि।का।अभि।/मुं।मुं।/नाहप्र/नस्ती क्र। - ९१९ व ५५७ / /१८,<br /> दिनांक: 
                    <br /> 
