...
<!--                     <p style="margin-bottom:0; line-height:0.25;">Vikhroli (E),</p>
            ...
            <div style="margin-top: 70px;">
                ...
                <table style="width: 100%; text-align: center; border-collapse: collapse; table-layout: fixed;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="border: 1px solid #000; padding: 5px 10px; text-align: left;"></td>
                            <td colspan="2" style="border: 1px solid #000; padding: 5px 10px; text-align: left;">Rs. {{ $ntw->numToWord((($calculationData->sharingCalculationSheet) !="" && $calculationData->sharingCalculationSheet->amount_to_b_paid_to_municipal_corporation != "" ) ? str_replace( ',', '',$calculationData->sharingCalculationSheet->amount_to_b_paid_to_municipal_corporation) : 0 ) }}</td>
                        </tr>
                        <tr>
                            <td style="border: 1px solid #000; padding: 5px 10px; text-align: left;"></td>
            ...
            <div style="margin-top: 30px; line-height: 1.5">
                ...
                <p style="text-indent: 25px; margin-top: 5px; margin-bottom: 5px;">An amount of
                 ...
                 (Rs. {{  $ntw->numToWord(($calculationData->sharingCalculationSheet) !="" && $calculationData->sharingCalculationSheet->total_amount_in_rs != "" ? str_replace( ',', '',$calculationData->sharingCalculationSheet->total_amount_in_rs) : 0 ) }}) may be paid in the office of the Chief Accounts Officer/ Mumbai Board, Third Floor, Griha Nirman Bhavan, Bandra (E), Mumbai – 400051 by Demand Draft/ Pay Order within SIX months from the date of issue of this letter and produce certified Xerox copy of the receipt in this office.</p> 
                ...
                (In words Rs. {{  $ntw->numToWord(($calculationData->sharingCalculationSheet) !="" && $calculationData->sharingCalculationSheet->amount_to_b_paid_to_municipal_corporation != "" ? str_replace( ',', '',$calculationData->sharingCalculationSheet->amount_to_b_paid_to_municipal_corporation) : 0 ) }}) in the office of the Executive Engineer, {{($calculationData->eeApplicationSociety->address ? $calculationData->eeApplicationSociety->address : '')}}., within SIX months from the date of issue of this letter  and produce certified Xerox copy of the receipt in this office.</p>                 
