                                ...
                                @csrf
                                    ...
                                    <input name="application_id" type="hidden" value="{{ $ol_application->id }}" />
                                            ...
                                            @foreach($ol_application->table1 as $data) 
                                                <tr>
                                                    ...
                                                    <input type="hidden" name="table1[{{$i}}][hiddenId]" value="{{ isset($data['id']) ? $data['id'] : '' }}">
                                                        <input type="text" class="form-control form-control--custom" name="table1[{{$i}}][title]" value="{{ isset($data['title'])? $data['title'] : '' }}">
                                                    </td>
                                                    <td class="text-center"> 
                                                        <input type="text" class="form-control form-control--custom" name="table1[{{$i}}][amount]" value="{{ isset($data['amount'])? $data['amount'] : '' }}">
                                                    </td>
                                        ...
                                        @else
                                            <tr>
                                                <td>
                                                    <input type="text" class="form-control form-control--custom" name="table1[1][title]" value="">
                                                </td>
                                                <td class="text-center"> 
                                                    <input type="text" class="form-control form-control--custom" name="table1[1][amount]" value="">
                                                </td>
                                ...
                                @csrf
                                    ...
                                    <table class="table mb-0 table--box-input table2">
                                            ...
                                            @foreach($ol_application->table2 as $data) 
                                                <tr>
                                                    ...
                                                    <input type="hidden" name="table2[{{$i}}][hiddenId]" value="{{ isset($data['id']) ? $data['id'] : '' }}">
                                                        <input type="text" class="form-control form-control--custom" name="table2[{{$i}}][title]" value="{{ isset($data['title'])? $data['title'] : '' }}">
                                                    </td>
                                                    <td class="text-center"> 
                                                        <input type="text" class="form-control form-control--custom" name="table2[{{$i}}][amount]" value="{{ isset($data['amount'])? $data['amount'] : '' }}">
                                                    </td>
                                        ...
                                        @else
                                            <tr>
                                                <td>
                                                    <input type="text" class="form-control form-control--custom" name="table2[1][title]" value="">
                                                </td>
                                                <td class="text-center"> 
                                                    <input type="text" class="form-control form-control--custom" name="table2[1][amount]" value="">
                                                </td>
                                ...
                                @csrf
                                    ...
                                    <table class="table mb-0 table--box-input table3">
                                        ...
                                        @php $i = 1; @endphp
                                            @foreach($ol_application->table3 as $data) 
                                                <tr>
                                                    ...
                                                    <td class="text-center"> 
                                                        <input type="text" class="form-control form-control--custom" name="table3[{{$i}}][amount]" value="{{ isset($data['amount'])? $data['amount'] : '' }}">
                                                    </td>
                                        ...
                                        @else
                                            <tr>
                                                <td>
                                                    <input type="text" class="form-control form-control--custom" name="table3[1][title]" value="">
                                                </td>
                                                <td class="text-center"> 
                                                    <input type="text" class="form-control form-control--custom" name="table3[1][amount]" value="">
                                                </td>
                                                <td><i class="fa fa-trash" id="delete1" aria-hidden="true" style="font-size: 20px;color: #b21c1c;cursor: pointer;" onclick="deleteRow(this.id);"></i></td>
                                            </tr> 
                                        @endif      
                                ...
                                @csrf
                                    ...
                                    <table class="table mb-0 table--box-input table4">
                                            ...
                                            @foreach($ol_application->table4 as $data) 
                                                <tr>
                                                    ...
                                                    <input type="hidden" name="table4[{{$i}}][hiddenId]" value="{{ isset($data['id']) ? $data['id'] : '' }}">
                                                        <input type="text" class="form-control form-control--custom" name="table4[{{$i}}][title]" value="{{ isset($data['title'])? $data['title'] : '' }}">
                                                    </td>
                                                    <td class="text-center"> 
                                                        <input type="text" class="form-control form-control--custom" name="table4[{{$i}}][amount]" value="{{ isset($data['amount'])? $data['amount'] : '' }}">
                                                    </td>
                                                    <td><i class="fa fa-trash deleteBtn" aria-hidden="true" id="table1_{{$data['id']}}" style="font-size: 20px;color: #b21c1c;cursor: pointer;"></i></td>
                                                </tr>  
                                            @php $i++; @endphp                                               
                                        ...
                                        @else
                                            <tr>
                                                <td>
                                                    <input type="text" class="form-control form-control--custom" name="table4[1][title]" value="">
                                                </td>
                                                <td class="text-center"> 
                                                    <input type="text" class="form-control form-control--custom" name="table4[1][amount]" value="">
                                                </td>
                                                <td><i class="fa fa-trash" aria-hidden="true" id="delete1" style="font-size: 20px;color: #b21c1c;cursor: pointer;" onclick="deleteRow(this.id);"></i></td>
                                            </tr> 
                                        @endif      
                                ...
                                <table class="table mb-0 table--box-input">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input type="text" class="form-control form-control--custom" name="table5[1][amount]" value="">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input type="text" class="form-control form-control--custom" name="table5[2][amount]" value="">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input type="text" class="form-control form-control--custom" name="table5[3][amount]" value="">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input type="text" class="form-control form-control--custom" name="table5[4][amount]" value="">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input type="text" class="form-control form-control--custom" name="table5[5][amount]" value="">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                    <div class="col-md-12 btn-list" style="padding-top: 13px;">
                                        <input type="button" name="add_more" id="table5" class="btn btn-primary btn-next add-more" value="Add More.." />
                                        <input type="submit" name="submit" class="btn btn-primary btn-next"
                                        value="Next" style="float:right"/> 
                                    </div> 
