...
<li id="ee-actions" class="collapse show">
    <ul class="list-unstyled">
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{($route=='ree.view_application_consent_oc')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{($route=='ree.society_oc_documents')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{($route=='ree.em_scrutiny_oc_ree')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{($route=='ree.ee_scrutiny_oc_ree')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{($route=='ree.generate_oc_certificate')?'m-menu__item--active':''}}">
        ...
        @endif
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{($route=='ree.ree-note-consentoc')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{($route=='ree.approved_consent_oc_letter')?'m-menu__item--active':''}}"
            aria-haspopup="true">
        ...
        @endif
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{($route=='ree-forward-application-oc')?'m-menu__item--active':''}}">
