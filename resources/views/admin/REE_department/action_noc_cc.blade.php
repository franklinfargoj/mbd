...
<li id="ree-actions" class="collapse show">
    <ul class="list-unstyled">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ree.view_application_noc_cc')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ree.society_noc_cc_documents')?'m-menu__item--active':''}}"
            aria-haspopup="true">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ree.scrutiny-remark-noc-cc')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ree.forward_application_noc_cc')?'m-menu__item--active':''}}"
            aria-haspopup="true">
