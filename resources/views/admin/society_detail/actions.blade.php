<div class="d-flex btn-icon-list">
    <a class="d-flex flex-column align-items-center" href="{{ route('society_detail.show', $society_data->id) }}"><span
    ...
    <a class="d-flex flex-column align-items-center" href="{{ route('lease_detail.index', $society_data->id) }}"><span
                class="btn-icon btn-icon--delete"><i style="color: #fff;" class="fa fa-file-text-o"></i></span>Lease</a>
