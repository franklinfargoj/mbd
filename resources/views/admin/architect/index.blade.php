        ...
        <div class="portlet light bordered">
          <div class="portlet-title tabbable-line">
            ...
            <ul class="nav nav-tabs">
              ...
              <li class="">
                <a href="{{url('shortlisted_architect_application')}}" class="aplListing" data-val="shortlisted" > Shortlisted </a>
              </li>
              <li class="">
                <a href="{{url('final_architect_application')}}"  class="aplListing" data-val="finalSelected" > Final list of selected cadidates </a>
              </li>
            </ul>
          </div>
          <div class="portlet-body">
