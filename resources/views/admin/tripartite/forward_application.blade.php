...
<div class="custom-wrapper">
    <div class="col-md-12">
        <div class="d-flex">
            {{ Breadcrumbs::render('ol_forward_application',$ol_application->id) }}
                            ...
                            <div class="row field-row">
                                ...
                                <div class="col-sm-6 field-col">
                                    <div class="d-flex">
                                        ...
                                        <span class="field-value">{{(isset($data->eeApplicationSociety->name)
                                            ? $data->eeApplicationSociety->name : '')}}</span>
                                    </div>
                                </div>
                                <div class="col-sm-6 field-col">
                                    <div class="d-flex">
                                        <span class="field-name">Society Address:</span>
                                        <span class="field-value">{{(isset($data->eeApplicationSociety->address)
                                            ? $data->eeApplicationSociety->address : '')}}</span>
                                    </div>
                                </div>
                                <div class="col-sm-6 field-col">
                                    <div class="d-flex">
                                        <span class="field-name">Building Number:</span>
                                        <span class="field-value">{{(isset($data->eeApplicationSociety->building_no)
                                            ? $data->eeApplicationSociety->building_no : '')}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row field-row">
                                <div class="col-sm-6 field-col">
                                    <div class="d-flex">
                                        ...
                                        <span class="field-value">{{(isset($data->eeApplicationSociety->name_of_architect)
                                            ? $data->eeApplicationSociety->name_of_architect : '')}}</span>
                                    </div>
                                </div>
                                <div class="col-sm-6 field-col">
                                    <div class="d-flex">
                                        <span class="field-name">Architect Mobile Number:</span>
                                        <span class="field-value">{{(isset($data->eeApplicationSociety->architect_mobile_no)
                                            ? $data->eeApplicationSociety->architect_mobile_no : '')}}</span>
                                    </div>
                                </div>
                                <div class="col-sm-6 field-col">
                                    <div class="d-flex">
                                        <span class="field-name">Architect Address:</span>
                                        <span class="field-value">{{(isset($data->eeApplicationSociety->architect_address)
                                            ? $data->eeApplicationSociety->architect_address : '')}}</span>
                                    </div>
                                </div>
                                <div class="col-sm-6 field-col">
                                    <div class="d-flex">
                                        <span class="field-name">Architect Telephone Number:</span>
                                        <span class="field-value">{{(isset($data->eeApplicationSociety->architect_telephone_no)
                                            ? $data->eeApplicationSociety->architect_telephone_no : '')}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="portlet-body">
                                ...
                                <div class="remark-body">
                                    <div class="remarks-section">
                                        <div class="m-scrollable m-scroller ps ps--active-y remarks-section-container"
                                            ...
                                            config('commanConfig.formation_status.reverted'))
                                            ...
                                            <div class="remarks-section__data">
                                                ...
                                                <p class="remarks-section__data__row"><span>Action:</span>
                                                    ...
                                                    <span>{{$status}} to {{isset($log->getRoleName->display_name) ?
                                                        $log->getRoleName->display_name : ''}} From
                                                        {{isset($log->getRole->display_name) ?
                                                        $log->getRole->display_name : ''}}</span></p>
                            ...
                            <div class="m-portlet__body m-portlet__body--table m-portlet__body--serial-no m-portlet__body--serial-no-pdf">
                                    <div class="border-bottom pb-2">
                                        ...
                                        <span class="hint-text d-block t-remark">Remark by La</span>
                                    </div>
                                    @if(count($LaLogs) > 0)
                                    <div class="remark-body">
                                        <div class="remarks-section">
                        ...
                        <div class="portlet-body">
                            <div class="m-portlet__body m-portlet__body--table m-portlet__body--serial-no m-portlet__body--serial-no-pdf">
                                ...
                                <div class="remarks-suggestions">
                                    <form action="{{ route('tripartite.post_forward_application') }}" id="forwardApplication"
                                        method="post">
                                        @csrf
                                                ...
                                                <div class="col-lg-4 col-md-9 col-sm-12">
                                                    <select class="form-control m-bootstrap-select m_selectpicker form-control--custom m-input"
                                                        ...
                                                        <option value="{{ $child->id }}" data-society="{{ ($child->role_id == $data->society_role_id) ? 1 : 0 }}"
                                                            ...
                                                            $child->roles[0]->display_name }}) </option>
                                                        @endforeach
