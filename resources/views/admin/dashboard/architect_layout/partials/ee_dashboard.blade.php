    ...
    <div class="m-portlet__body m-portlet__body--hearing m-portlet__body--spaced collapse show" id="layout_forwarded_for_approval"
        ...
        <div class="row hearing-row">
            ...
            <div class="col">
                ...
                <h2 class="app-no mb-0">{{$data['ee_forwarded_layouts']}}</h2>
                    <a href="" class="app-card__details mb-0">View Details</a>
                </div>
            </div>
        </div>
    ...
    <div class="m-portlet__body m-portlet__body--hearing m-portlet__body--spaced collapse show" id="layout_forwarded_for_ee_head"
        ...
        <div class="row hearing-row">
            ...
            <div class="col">
                ...
                <h2 class="app-no mb-0">{{$data['jr_ee_pending']}}</h2>
                    <a href="" class="app-card__details mb-0">View Details</a>
                </div>
            </div>
            <div class="col">
                ...
                <h2 class="app-no mb-0">{{$data['dy_ee_pending']}}</h2>
                    <a href="" class="app-card__details mb-0">View Details</a>
                </div>
            </div>
            <div class="col">
                ...
                <h2 class="app-no mb-0">{{$data['head_ee_pending']}}</h2>
                    <a href="" class="app-card__details mb-0">View Details</a>
                </div>
            </div>
        </div>
