    ...
    <div class="m-portlet__body m-portlet__body--hearing m-portlet__body--spaced collapse show" id="sap_layouts"
        ...
        <div class="row hearing-row">
            ...
            <div class="col">
                ...
                <h2 class="app-no mb-0">{{$data['layouts_pending_at_sap']}}</h2>
            ...
            <div class="col">
                ...
                <h2 class="app-no mb-0">{{$data['sap_forwarded_layouts']}}</h2>
                    <a href="" class="app-card__details mb-0">View Details</a>
                </div>
            </div>
            <div class="col">
                ...
                <h2 class="app-no mb-0">{{$data['sap_reverted_layouts']}}</h2>
                    <a href="" class="app-card__details mb-0">View Details</a>
                </div>
            </div>
        </div>
