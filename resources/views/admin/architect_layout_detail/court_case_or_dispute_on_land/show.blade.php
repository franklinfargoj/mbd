                ...
                <div class="m-subheader">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 form-group">
                            ...
                            <input disabled type="text" name="document_name" class="form-control form-control--custom" value="{{old('document_name')!=""?old('document_name'):$courCassesOrDisputes->document_name}}">
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-6 form-group">
                                <div class="custom-file">
                                        <textarea disabled type="text" name="description" id="description" class="form-control form-control--custom form-control--fixed-height">{{old('description')!=""?old('description'):$courCassesOrDisputes->description}}</textarea>
