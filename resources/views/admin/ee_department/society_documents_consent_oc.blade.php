...
<div class="col-md-12">
   <div class="m-subheader px-0 m-subheader--top">
      <div class="d-flex align-items-center">
         ...
         {{ Breadcrumbs::render('ee_society_documents_oc',$oc_application->id) }}
         ...
         <div class="m-section mb-0">
            <div class="m-section__content mb-0 table-responsive">
               <table class="table mb-0">
                  ...
                  <tbody>
                     <?php $i=0; ?>
                     @foreach($societyDocument[0]->societyOcDocuments as $data)
                     <tr>
                        <td>{{ $i+1}}.</td>
...
@if($societyDocument[0]->documentCommentsforOc)        
<div class="col-md-12">
               ...
               <div class="remarks-suggestions table--box-input">
                  <div class="mt-3">
                     ...
                     <div class="@if($errors->has('society_documents_comment')) has-error @endif">
                        <textarea name="society_documents_comment" rows="5" cols="30" id="society_documents_comment" class="form-control form-control--custom" readonly>{{ $societyDocument[0]->documentCommentsforOc->society_documents_comment }}</textarea>
