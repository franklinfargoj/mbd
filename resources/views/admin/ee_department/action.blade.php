...
<li id="ee-actions" class="collapse show">
    <ul class="list-unstyled">
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ee.view_application')?'m-menu__item--active':''}}">
            <a class="m-menu__link m-menu__toggle" title="view_Application" href="{{ route('ee.view_application', encrypt($ol_application->id)) }}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='scrutiny-remark')?'m-menu__item--active':''}}">
            <a class="m-menu__link m-menu__toggle" href="{{ route('scrutiny-remark',[encrypt($ol_application->id), encrypt($ol_application->society_id)]) }}"> 
                <span class="sidebar-icon sidebar-menu-icon--level-1">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='get-forward-application')?'m-menu__item--active':''}}">
            <a class="m-menu__link m-menu__toggle" href="{{ route('get-forward-application', encrypt($ol_application->id)) }}">
                <span class="sidebar-icon sidebar-menu-icon--level-1">
