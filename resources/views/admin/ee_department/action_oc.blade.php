...
<li class="m-menu__item" >
    <a href="{{route('ee.consent_for_oc')}}" class="m-menu__link m-menu__toggle">
...
<li id="ee-actions" class="collapse show">
    <ul class="list-unstyled">
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ee.view_oc_application')?'m-menu__item--active':''}}">
            <a class="m-menu__link m-menu__toggle" title="view_Application" href="{{ route('ee.view_oc_application', encrypt($oc_application->id)) }}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ee.society_documents_oc')?'m-menu__item--active':''}}">
            <a class="m-menu__link m-menu__toggle" href="{{ route('ee.society_documents_oc', encrypt($oc_application->id)) }}">
                <span class="sidebar-icon sidebar-menu-icon--level-1">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ee.scrutiny-remark-oc')?'m-menu__item--active':''}}">
            <a class="m-menu__link m-menu__toggle" href="{{ route('ee.scrutiny-remark-oc', encrypt($oc_application->id)) }}">
                <span class="sidebar-icon sidebar-menu-icon--level-1">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='ee-forward-application-oc')?'m-menu__item--active':''}}">
            <a class="m-menu__link m-menu__toggle" href="{{ route('ee-forward-application-oc', encrypt($oc_application->id)) }}">
                <span class="sidebar-icon sidebar-menu-icon--level-1">
