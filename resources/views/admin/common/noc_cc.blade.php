...
<div class="col-md-12">
    <div class="m-subheader px-0 m-subheader--top">
        <div class="d-flex align-items-center">
            ...
            @endphp
            @if($route_name=='ree.view_application_noc_cc')
            {{ Breadcrumbs::render('view_noc_cc_application_ree',$noc_application->id) }}
            @elseif($route_name=='co.view_application_noc_cc')
