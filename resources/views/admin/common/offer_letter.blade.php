...
@csrf
	...
	<div class="m-content letter-form-content">
		<div class="letter-form-subject">
			<p><span class="font-weight-semi-bold">विषय :- </span>इमारत क्र. <input class="letter-form-input letter-form-input--xs" type="text" id="" name="building_no" value="{{ $ol_application->eeApplicationSociety->building_no }}" readonly>, <input class="letter-form-input letter-form-input--xl" type="text" id="" name="name" value="{{ $ol_application->eeApplicationSociety->name }}" readonly> सहकारी गृहनिर्माण संस्थेच्या स्वयंपुनर्विकासाच्या प्रस्तावास मंजूरी मिळण्याबाबतचा अर्ज.</p>
			<p class="font-weight-semi-bold">महोदय,</p>
			<p>आम्ही <input class="letter-form-input letter-form-input--lg" type="text" id="" name="name" value="{{ $ol_application->eeApplicationSociety->name }}" readonly> सहकारी गृहनिर्माण संस्थेचे पदाधिकारी ( इमारत क्र. <input class="letter-form-input letter-form-input--xs" type="text" id="" name="building_no" value="{{ $ol_application->eeApplicationSociety->building_no }}" readonly> पत्ता - <input class="letter-form-input letter-form-input--xl" type="text" id="" name="address" value="{{ $ol_application->eeApplicationSociety->address }}" readonly>) आपणांस विनंती करतो की, आम्ही रहात असलेल्या सदरहू इमारतीचा स्वयंपुनर्विकास विकास नियंत्रण नियमावली ३३ (५) अंतर्गत अधिमुल्य आधारित तत्वावर करु इच्छितो. आमच्या गृहनिर्माण संस्थेने दिनांक <input class="letter-form-input letter-form-input--md" type="text" id="m_datepicker" name="date_of_meeting" value="{{ $ol_application->request_form->date_of_meeting }}" readonly disabled> रोजी स्वयंपुनर्विकासासंदर्भात सर्वसाधारण सभेचा ठराव क्र. <input class="letter-form-input letter-form-input--md" type="text" id="" name="resolution_no" value="{{ $ol_application->request_form->resolution_no }}" readonly> अन्वये निर्णय घेतला आहे.</p>
