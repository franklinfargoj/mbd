                ...
                <div class="portlet-body">
                    <div class="m-portlet__body m-portlet__body--table" id="calculation">
                        <div class="m-subheader">
                            Building/Chawl No. 
                            <input class="letter-form-input letter-form-input--md" type="text" name="chawl_no" value="{{ isset($data->ConveyanceSalePriceCalculation->chawl_no) ? $data->ConveyanceSalePriceCalculation->chawl_no : '' }}" readonly style="border: none;border-bottom: 1px solid #212529;"> 
                            Consisting 
                            <input class="letter-form-input letter-form-input--md" type="text"  name="consisting" 
                            value="{{ isset($data->ConveyanceSalePriceCalculation->consisting) ? $data->ConveyanceSalePriceCalculation->consisting : '' }}" readonly style="border: none;border-bottom: 1px solid #212529;"> 
                             T/S Out of Project of 
                             <input class="letter-form-input letter-form-input--md"
                                    type="text" name="project_of" value="{{ isset($data->ConveyanceSalePriceCalculation->project_of) ? $data->ConveyanceSalePriceCalculation->project_of : '' }}" readonly style="border: none;border-bottom: 1px solid #212529;">
                            T/S Under 
                            <input class="letter-form-input letter-form-input--md"
                                    type="text" name="ts_under" value="{{ isset($data->ConveyanceSalePriceCalculation->ts_under) ? $data->ConveyanceSalePriceCalculation->ts_under : '' }}" readonly style="border: none;border-bottom: 1px solid #212529;">  
                            Income Group at
                            <input class="letter-form-input letter-form-input--md"
                                    type="text" name="income_group" value="{{ isset($data->ConveyanceSalePriceCalculation->income_group) ? $data->ConveyanceSalePriceCalculation->income_group : '' }}" readonly style="border: none;border-bottom: 1px solid #212529;"> 
                        </div>
                            ...
                            <input type="hidden" name="application_id" value="{{ isset($data->id) ? $data->id : '' }}">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input type="text" style="border: none;" class="form-control form-control--custom" name="common_service_rate" value="{{ isset($data->ConveyanceSalePriceCalculation->common_service_rate) ? $data->ConveyanceSalePriceCalculation->common_service_rate : '' }}" readonly/>
                                            </td>
                                        </tr>                                        
                                        <tr>
                                            <td>2.</td>
                                            ...
                                            <td class="text-center">
                                                <input type="text" style="border: none;" class="txtbox v_text form-control form-control--custom m-input m_datepicker" name="pump_house" id="pump_house" value="{{ isset($data->ConveyanceSalePriceCalculation->pump_house) ? $data->ConveyanceSalePriceCalculation->pump_house : '' }}" aria-describedby="visit_date-error" aria-invalid="false" readonly disabled>
                                            </td>
                                        </tr>                                       
                                         <tr>
                                            <td>3.</td>
                                            ...
                                            <td class="text-center">
                                                <input type="text" style="border: none;" class="form-control form-control--custom" name="tenement_plinth_area" value="{{ isset($data->ConveyanceSalePriceCalculation->tenement_plinth_area) ? $data->ConveyanceSalePriceCalculation->tenement_plinth_area : '' }}" readonly/>
                                            </td>
                                        </tr>                                        
                                        <tr>
                                            <td>4.</td>
                                            ...
                                            <td class="text-center">
                                                <input type="text" style="border: none;" class="form-control form-control--custom" name="tenement_carpet_area" value="{{ isset($data->ConveyanceSalePriceCalculation->tenement_carpet_area) ? $data->ConveyanceSalePriceCalculation->tenement_carpet_area : '' }}" readonly/>
                                            </td>
                                        </tr>                                        
                                        <tr>
                                            <td>5.</td>
                                            ...
                                            <td class="text-center">
                                                <input type="text" style="border: none;" class="form-control form-control--custom" name="building_plinth_area" value="{{ isset($data->ConveyanceSalePriceCalculation->building_plinth_area) ? $data->ConveyanceSalePriceCalculation->building_plinth_area : '' }}" readonly/>
                                            </td>
                                        </tr>                                        
                                        <tr>
                                            <td>6.</td>
                                            ...
                                            <td class="text-center">
                                                <input type="text" style="border: none;" class="form-control form-control--custom" name="building_carpet_area" value="{{ isset($data->ConveyanceSalePriceCalculation->building_carpet_area) ? $data->ConveyanceSalePriceCalculation->building_carpet_area : '' }}" readonly/>
                                            </td>
                                        </tr>                                        
                                        <tr>
                                            <td>7.1.</td>
                                         ...
                                         <tr>
                                            ...
                                            <td class="text-center">
                                                <input type="text" style="border: none;" class="form-control form-control--custom" name="land_premiun_infrastructure" value="{{ isset($data->ConveyanceSalePriceCalculation->land_premiun_infrastructure) ? $data->ConveyanceSalePriceCalculation->land_premiun_infrastructure : '' }}" readonly/>
                                            </td>
                                        </tr>                                        
                                         <tr>
                                            <td></td>
                                            ...
                                            <td class="text-center">
                                                <input type="text" style="border: none;" class="form-control form-control--custom" name="final_sale_price_tenement" value="{{ isset($data->ConveyanceSalePriceCalculation->final_sale_price_tenement) ? $data->ConveyanceSalePriceCalculation->final_sale_price_tenement : '' }}" readonly/>
                                            </td>
                                        </tr>                                        
                                         <tr>
                                            <td>8</td>
                                ...
                                <div class="mt-3">
                                    ...
                                    <p>All the Piece or Parcel of land bearing Plot/ Building No 
                                     ...
                                     Admeasuring 
                                    <input class="letter-form-input letter-form-input--md" type="text" name="admeasure" value="{{ isset($data->ConveyanceSalePriceCalculation->admeasure) ? $data->ConveyanceSalePriceCalculation->admeasure : '' }}" readonly style="border: none;border-bottom: 1px solid #212529;">
                                    Sq.mtrs. There about being S.No
                                     <input class="letter-form-input letter-form-input--md" type="text" name="s_no"
                                            value="{{ isset($data->ConveyanceSalePriceCalculation->s_no) ? $data->ConveyanceSalePriceCalculation->s_no : '' }}" readonly style="border: none;border-bottom: 1px solid #212529;"> 

                                    and C.T.S No 

                                    <input class="letter-form-input letter-form-input--md" type="text" name="CTS_no" value="{{ isset($data->ConveyanceSalePriceCalculation->CTS_no) ? $data->ConveyanceSalePriceCalculation->CTS_no : '' }}" readonly style="border: none;border-bottom: 1px solid #212529;">
                                    Situated at 

                                    <input class="letter-form-input letter-form-input--md" type="text" name="situated_at" value="{{ isset($data->ConveyanceSalePriceCalculation->situated_at) ? $data->ConveyanceSalePriceCalculation->situated_at : '' }}" readonly style="border: none;border-bottom: 1px solid #212529;"> 
                                    In the registrations district of 
                                    <input class="letter-form-input letter-form-input--md" type="text" name="district" value="{{ isset($data->ConveyanceSalePriceCalculation->district) ? $data->ConveyanceSalePriceCalculation->district : '' }}" readonly style="border: none;border-bottom: 1px solid #212529;"> District and Bounded that is to say.
                                    </p>
                                    <p>On or towards the North By: <input class="letter-form-input letter-form-input--md"
                                            type="text" name="north_dimension" value="{{ isset($data->ConveyanceSalePriceCalculation->north_dimension) ? $data->ConveyanceSalePriceCalculation->north_dimension : '' }}" readonly style="border: none;border-bottom: 1px solid #212529;"></p>

                                    <p>On or towards the South By:

                                     <input class="letter-form-input letter-form-input--md"
                                            type="text" name="south_dimension" value="{{ isset($data->ConveyanceSalePriceCalculation->south_dimension) ? $data->ConveyanceSalePriceCalculation->south_dimension : '' }}" readonly style="border: none;border-bottom: 1px solid #212529;"></p>
                                    <p>
                                    On or towards the West By: 

                                    <input class="letter-form-input letter-form-input--md"
                                            type="text" name="west_dimension" value="{{ isset($data->ConveyanceSalePriceCalculation->west_dimension) ? $data->ConveyanceSalePriceCalculation->west_dimension : '' }}" readonly style="border: none;border-bottom: 1px solid #212529;"></p>
                                    <p>On or towards the East By: 

                                    <input class="letter-form-input letter-form-input--md"
                                            type="text" name="east_dimension" value="{{ isset($data->ConveyanceSalePriceCalculation->east_dimension) ? $data->ConveyanceSalePriceCalculation->east_dimension : '' }}" readonly style="border: none;border-bottom: 1px solid #212529;"></p>
                                </div>                                                          
                        </div>
                    </div>
                </div>
