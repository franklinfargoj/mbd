                ...
                <div class="col-sm-10 table-responsive" style="top: 25px;left: 30px;">
                    <table class="mt-2 table table-hover" id="dtBasicExample"> 
                        ...
                        <tbody>
                                ...
                                <tr>
                                    <td>{{ $i }}</td>
                                    <td> {{ isset($document->other_document_name) ? $document->other_document_name : '' }} </td>
                                    <td class=""> 
                                        <a class="btn-link" href="{{ config('commanConfig.storage_server').'/'.$document->document_path }}" download target="_blank"> Download </a> 
                                    </td> 
                                </tr>
                                @php $i++;@endphp 
                                @endforeach 
