...
<li id="dyco-actions" class="collapse show">
    ...
    @if(isset($data->application_status) && $data->application_status == config('commanConfig.conveyance_status.Draft_sale_&_lease_deed'))
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='conveyance.sale_lease_agreement')?'m-menu__item--active':''}}">
    ...
    @if(isset($data->application_status) && ($data->application_status == config('commanConfig.conveyance_status.Approved_sale_&_lease_deed') || $data->application_status == config('commanConfig.conveyance_status.Send_society_to_pay_stamp_duty')) )    
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='conveyance.approved_sale_lease_agreement')?'m-menu__item--active':''}}">
    ...
    @if(isset($data->application_status) && $data->application_status == config('commanConfig.conveyance_status.Stamped_sale_&_lease_deed'))
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='conveyance.stamp_duty_agreement')?'m-menu__item--active':''}}">
    ...
    @if(isset($data->application_status) && ($data->application_status == config('commanConfig.conveyance_status.Stamped_signed_sale_&_lease_deed') || $data->application_status == config('commanConfig.conveyance_status.Send_society_for_registration_of_sale_&_lease')) )       
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-2 {{($route=='conveyance.stamp_signed_duty_agreement')?'m-menu__item--active':''}}">
