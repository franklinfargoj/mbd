...
@php
    ...
    else if(isset($data->ApproveDraftSaleAgreement->document_path))
        $document = $data->ApproveDraftSaleAgreement->document_path;
@endphp
@php
    ...
    else if(isset($data->ApprovedDraftLeaseAgreement->document_path))
        $document1 = $data->ApprovedDraftLeaseAgreement->document_path;
@endphp
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="d-flex flex-column h-100 two-cols">
                                            ...
                                            <div class="mt-auto">
                                                @if(isset($data->ApproveDraftSaleAgreement))
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="d-flex flex-column h-100 two-cols">
                                            ...
                                            <div class="mt-auto">
                                                @if(isset($data->ApprovedDraftLeaseAgreement))
                                            ...
                                            <div class="d-flex flex-column h-100 two-cols">
                                                ...
                                                <span class="hint-text">Click to upload Lease Deed Agreement</span>
                                                    <div class="custom-file">
                                                     ...
                                                     <div class="mt-3">
                                                        <input type="submit" id="lease_btn" class="btn btn-primary mt-3 upload_btn" style="display:block" value="Upload">  
                                                     </div>
                                            </div>
                                        </div>
                                        @endif
                        ...
                        <div class="col-sm-6 border-left">
                                <div class="d-flex flex-column h-100 two-cols">
                                    ...
                                    <div class="mt-auto">
                                        ...
                                        @else
                                        <span class="error" style="display: block;color: #ce2323;margin-bottom: 17px;">
                                            *Note : Stamp Duty Letter is not generated.</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
            ...
            <div class="m-portlet__body">   
                <div class="col-xs-12 row">
                    <div class="col-md-12">
                        ...
                        <textarea rows="4" cols="63" name="remark" class="form-control form-control--custom" readonly>{{ isset($data->riders) ? $data->riders : '' }}</textarea>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="saleAgreement" action="{{ route('dyco.approveDaftSaleLeaseAgreement') }}" method="POST">
                @csrf 
                 <input type="hidden" name="oldDraftSale" value="{{ isset($data->ApproveDraftSaleAgreement) ?  $data->ApproveDraftSaleAgreement->document_path : '' }}"> 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="saleAgreement" action="{{ route('dyco.approveDaftSaleLeaseAgreement') }}" method="POST">
                @csrf 
                 <input type="hidden" name="oldDraftLease" value="{{ isset($data->ApprovedDraftLeaseAgreement) ?  $data->ApprovedDraftLeaseAgreement->document_path : '' }}">
