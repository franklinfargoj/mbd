...
<li id="vp-actions" class="collapse show">
    <ul class="list-unstyled">
        <li class="m-menu__item m-menu__item--submenu {{($route=='vp.view_application')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu {{($route=='vp.society_EE_documents')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu {{($route=='vp.EE_scrutiny_remark')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu {{($route=='vp.dyce_Scrutiny_Remark')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu {{($route=='vp.show_calculation_sheet')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu {{($route=='vp.forward_application')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu {{($route=='vp.cap_notes')?'m-menu__item--active':''}}">
