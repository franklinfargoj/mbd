...
<li id="ree-actions" class="collapse show">
    <ul class="list-unstyled">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{($route=='vp.view_reval_application')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{($route=='vp.society_reval_documents')?'m-menu__item--active':''}}"
            aria-haspopup="true">
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{($route=='vp.show_reval_calculation_sheet')?'m-menu__item--active':''}}"
            aria-haspopup="true">
