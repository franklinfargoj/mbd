    ...
    <div class="col-md-12">
        <div class="m-subheader px-0 m-subheader--top">
            <div class="d-flex align-items-center">
                <h3 class="m-subheader__title m-subheader__title--separator">Add Ward</h3>
                {{ Breadcrumbs::render('add_ward') }}
        ...
        <div class="m-portlet m-portlet--mobile">
            <form id="addward" role="form" method="post" class="m-form m-form--rows m-form--label-align-right" action="{{route('ward.store')}}" enctype="multipart/form-data">
                @csrf
