...
<div class="col-md-12">
    ...
    <div class="m-subheader px-0 m-subheader--top">
        <div class="d-flex align-items-center">
            <h3 class="m-subheader__title m-subheader__title--separator">Society Billing details - @if(!empty($society)){{$society->name}}@endif @if(!empty($building)){{$building->name}}@endif</h3>
