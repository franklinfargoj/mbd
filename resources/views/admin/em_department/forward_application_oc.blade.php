...
<div class="custom-wrapper">
   <div class="col-md-12">
      <div class="d-flex">
         {{ Breadcrumbs::render('Forward_Application_oc_em',$oc_application->id) }}
      ...
      <div class="">
         <ul class="nav nav-tabs m-tabs-line m-tabs-line--primary m-tabs-line--2x nav-tabs--custom">
            ...
            @if($arrData['get_current_status']->status_id == config('commanConfig.applicationStatus.in_process') && !empty($oc_application->no_dues_certificate_draft) && !empty($oc_application->em_office_note_oc))
               ...
               <div class="portlet-body">
                  <div class="m-portlet__body m-portlet__body--table m-portlet__body--serial-no m-portlet__body--serial-no-pdf">
                     ...
                     <div class="remarks-suggestions">
                        <form action="{{ route('em.forward_oc_application_data') }}"
                           ...
                           <div class="m-form__group form-group">
                              ...
                              @if(!empty($oc_application->no_dues_certificate_draft) && !empty($oc_application->em_office_note_oc))
                              <div class="mt-3 btn-list">
                                 <button type="submit" class="btn btn-primary">Save</button>
                                 <button type="button" onclick="window.location.href='{{ url("/consentoc_em") }}'"
                                 class="btn btn-secondary">Cancel</button>
                              </div>
                              @else                                    
                              <div>
                                 <span class="error" style="display: block;color: #ce2323;margin-top: 13px;">
                                 * Please complete scrutiny section to forward application. </span>
                              </div>
                              @endif
                           </div>
