                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Flat No.</label>
                                            ...
                                            <div class="input-icon right">
                                                 <input type="text" name="flat_no" id="flat_no" class="form-control form-control--custom m-input" value="{{old('flat_no', $tenant->flat_no)}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">First name</label>
                                            ...
                                            <div class="input-icon right">
                                                 <input type="text" name="first_name" id="first_name" class="form-control form-control--custom m-input" value="{{old('first_name', $tenant->first_name)}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Middle name</label>
                                            ...
                                            <div class="input-icon right">
                                                 <input type="text" name="middle_name" id="middle_name" class="form-control form-control--custom m-input" value="{{old('middle_name', $tenant->middle_name)}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Last name</label>
                                            ...
                                            <div class="input-icon right">
                                                 <input type="text" name="last_name" id="last_name" class="form-control form-control--custom m-input" value="{{old('last_name', $tenant->last_name)}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Mobile</label>
                                            ...
                                            <div class="input-icon right">
                                                 <input type="text" name="mobile" id="mobile" class="form-control form-control--custom m-input" value="{{old('mobile', $tenant->mobile)}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Email ID</label>
                                            ...
                                            <div class="input-icon right">
                                                 <input type="text" name="email_id" id="email_id" class="form-control form-control--custom m-input" value="{{old('email_id', $tenant->email_id)}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Carpet Area</label>
                                            ...
                                            <div class="input-icon right">
                                                 <input type="text" name="carpet_area" id="carpet_area" class="form-control form-control--custom m-input" value="{{old('carpet_area', $tenant->carpet_area)}}">
