        ...
        <div class="col-md-12">
            ...
            <div class="portlet box purple">
                ...
                <div class="portlet-body form" style="display: block;">
                    <form id="addHearingForm" role="form" method="post" class="form-horizontal" action="{{route('hearing.store')}}">
                        @csrf
                        ...
                        <div class="form-body">
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" id="applicant_name" name="applicant_name" class="form-control"  value="{{ old('applicant_name') }}"  />
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" id="applicant_mobile_no" name="applicant_mobile_no" class="form-control"  value="{{ old('applicant_mobile_no') }}"  />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <textarea id="applicant_address" name="applicant_address" class="form-control">{{ old('applicant_address') }}</textarea>
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" id="respondent_name" name="respondent_name" class="form-control"  value="{{ old('respondent_name') }}"  />
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" id="respondent_mobile_no" name="respondent_mobile_no" class="form-control"  value="{{ old('respondent_mobile_no') }}"  />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <textarea  id="respondent_address" name="respondent_address" class="form-control">{{ old('respondent_address') }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" id="case_type" name="case_type" class="form-control"  value="{{ old('case_type') }}"  />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" id="office_number" name="office_number" class="form-control"  value="{{ old('office_number') }}"  />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" id="office_tehsil" name="office_tehsil" class="form-control"  value="{{ old('office_tehsil') }}"  />
                                        <span class="help-block">{{$errors->first('office_tehsil')}}</span>
                                    </div>
                                    <label class="col-md-3 control-label" for="office_village">Village</label>
                                    <div class="col-md-3">
                                        <input type="text" id="office_village" name="office_village" class="form-control"  value="{{ old('office_village') }}"  />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <textarea id="office_remark" name="office_remark" class="form-control">{{ old('office_remark') }}</textarea>
