...
<li id="hearing-actions" class="collapse show">
    <ul class="list-unstyled">
        <li class="m-menu__item m-menu__item--submenu {{($route=='hearing.show')?'m-menu__item--active':''}}">
    ...
    @if($hearing_data->hearingStatusLog[0]->hearing_status_id != config('commanConfig.hearingStatus.case_closed'))
        ...
        @if(in_array('hearing.edit', session()->get('permission')))
            ...
            @if($hearing_data->hearingSchedule)
                <li class="m-menu__item m-menu__item--submenu {{($route=='schedule_hearing.add')?'m-menu__item--active':''}}">
            ...
            @if($hearing_data->hearingSchedule)
                @if(count($hearing_data->hearingSchedule->prePostSchedule))
                    <li class="m-menu__item m-menu__item--submenu {{($route=='fix_schedule.edit')?'m-menu__item--active':''}}">
                ...
                @else
                    <li class="m-menu__item m-menu__item--submenu {{($route=='fix_schedule.add')?'m-menu__item--active':''}}">
            ...
            @if(count($hearing_data->hearingUploadCaseJudgement) > 0)
                <li class="m-menu__item m-menu__item--submenu {{($route=='upload_case_judgement.edit')?'m-menu__item--active':''}}">
            ...
            @else
                <li class="m-menu__item m-menu__item--submenu {{($route=='upload_case_judgement.add')?'m-menu__item--active':''}}">
        ...
        <li class="m-menu__item m-menu__item--submenu {{($route=='forward_case.edit')?'m-menu__item--active':''}}">
        ...
        @else
            <li class="m-menu__item m-menu__item--submenu {{($route=='forward_case.create')?'m-menu__item--active':''}}">
        ...
        @if(in_array('send_notice_to_appellant.edit', session()->get('permission')))
            @if($hearing_data->hearingSchedule)
                @if(count($hearing_data->hearingSendNoticeToAppellant))
                    <li class="m-menu__item m-menu__item--submenu {{($route=='send_notice_to_appellant.edit')?'m-menu__item--active':''}}">
                ...
                @else
                    <li class="m-menu__item m-menu__item--submenu {{($route=='send_notice_to_appellant.create')?'m-menu__item--active':''}}">
