                    ...
                    <form id="editHearingForm" role="form" method="post" class="form-horizontal" action="{{route('hearing.update', $arrData['hearing']->id)}}">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="text" id="case_number" name="case_number" class="form-control validate"  value="{{ $arrData['hearing']->case_number }}"  readonly/>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" id="office_date" name="office_date" class="form-control"  value="{{ $arrData['hearing']->office_date }}"  readonly/>
