...
@section('content')
    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        <form id="editUploadCaseJudgement" role="form" method="post" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="{{route('upload_case_judgement.update', $arrData['hearing_data']->id)}}" enctype="multipart/form-data">
            @csrf
            @method("PUT")
