        ...
        <div class="col-md-12">
            ...
            <div class="portlet box purple">
                ...
                <div class="portlet-body form" style="display: block;">
                    <form id="editUploadCaseJudgement" role="form" method="post" class="form-horizontal" action="{{route('upload_case_judgement.update', $arrData['hearing_data']->id)}}" enctype="multipart/form-data">
                        @csrf
                        @method("PUT")
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input type="file" id="upload_judgement_case" name="upload_judgement_case" class="form-control file-upload">{{ $arrData['hearing_data']->hearingUploadCaseJudgement[0]->judgement_case_filename }}
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <textarea id="description" name="description" class="form-control">{{ $arrData['hearing_data']->hearingUploadCaseJudgement[0]->description }}</textarea>
