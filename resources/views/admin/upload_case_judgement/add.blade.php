...
@section('content')
    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        <form id="uploadCaseJudgement" role="form" method="post" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="{{route('upload_case_judgement.store')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="m-input-icon m-input-icon--right">
                            <input type="file" id="upload_judgement_case" name="upload_judgement_case" class="form-control m-input"  value="{{ old('upload_judgement_case') }}">
