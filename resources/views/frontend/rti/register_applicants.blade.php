                                    ...
                                    <div class="form-group m-form__group row" style="margin-left: -15px; margin-right: -15px;">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="form-control form-control--custom m-input m_datepicker" type="text"
                                                placeholder="Select a Date" name="info_period_from" autocomplete="off">
                                        </div>
                                        <div class="col-sm-6">
                                            <input class="form-control form-control--custom m-input m_datepicker"
                                                type="text" placeholder="Select a Date" name="info_period_to"
                                                autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group m-form__group">
                                        ...
                                        <textarea class="form-control form-control--custom form-control--textarea m-input"
                                            type="text" placeholder="Enter Description" name="info_descr" autocomplete="off"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
