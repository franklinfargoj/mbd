...
<div class="m-grid__item m-grid__item--fluid  m-grid__item--order-tablet-and-mobile-1  m-login__wrapper">
    ...
    <!--begin::Body-->
    <div class="m-login__body min-height-100vh">
        <!--begin::Signin-->
        <div class="m-login__signin">
            ...
            <form class='m-login__form m-form' id='rti_frontend_register' method="post" action="{{ route('rti_frontend.store') }}">
                ...
                <div class="form-group m-form__group">
                    ...
                    <input class="form-control form-control--custom m-input" type="text" placeholder="Mobile No" name="mobile_no"
                        autocomplete="off" data-container="body" data-toggle="m-tooltip" data-placement="right" title=""
                        data-original-title="Mobile number must contain exactly 10 numbers.(+91) is by default considered.."
                        data-skin="dark">
                </div>
                <div class="form-group m-form__group">
                    <!-- <label for="" class="col-form-label">Email Address</label> -->
                    <input class="form-control form-control--custom m-input" id="email_val" type="text" placeholder="Email"
                        name="email" autocomplete="off" data-container="body" data-toggle="m-tooltip" data-placement="right"
                        title="" data-original-title="This field must contain a valid email address.." data-skin="dark">
