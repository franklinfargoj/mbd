        ...
        <div class="m-scrollable m-scroller ps ps--active-y" data-scrollbar-shown="true" data-scrollable="true"
            ...
            <ul class="m-menu__nav m-menu__nav--dropdown-submenu-arrow">
                ...
                {{--<ul id="society_ol_sidebar">--}}
                    ...
                    <li class="m-menu__item m-menu__item--submenu {{($route=='society_formation.create')?'m-menu__item--active':''}}">
                        <a class="m-menu__link m-menu__toggle" title="view_Application" href="{{ route('society_formation.create') }}">
                            <i class="m-menu__link-icon flaticon-line-graph"></i>
                            <span class="m-menu__link-title">
                                <span class="m-menu__link-wrap">
                                    <span class="m-menu__link-text">
