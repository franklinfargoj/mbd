                ...
                {{--<ul id="society_ol_sidebar">--}}
                    ...
                    <li id="redevelopment" class="collapse {{ ((Request::segment(2)=='application' && Request::segment(3) == '1_premium') || (Request::segment(2)=='application' && Request::segment(3) == '1_sharing') || (Request::segment(2)=='application' && Request::segment(3) == '12_premium') || (Request::segment(2)=='application' && Request::segment(3) == '12_sharing') || $route == 'society_offer_letter_dashboard' || $route == 'show_form_self' || $route == 'show_form_dev' || $route == 'show_tripatite_self' || $route == 'show_tripatite_dev' || $route == 'show_reval_self' || $route == 'show_reval_dev')? 'show':'' }}">
                        <ul class="list-unstyled">
                            ...
                            <li id="self-redevelopment" class="collapse {{ ((Request::segment(2)=='application' && Request::segment(3) == '1_premium') || (Request::segment(2)=='application' && Request::segment(3) == '1_sharing') || (isset($ids) && $ids[1] == 'sharing' && $route == 'show_form_self') || (isset($ids) && $ids[1] == 'premium' && $route == 'show_form_self') || (isset($ids) && $ids[1] == 'sharing' && $route == 'show_tripatite_self') || (isset($ids) && $ids[1] == 'premium' && $route == 'show_reval_self') || (isset($ids) && $ids[1] == 'sharing' && $route == 'show_reval_self'))? 'show':'' }}">
                                <ul class="list-unstyled">
                                    <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{ ((Request::segment(2)=='application' && Request::segment(3) == '1_premium') || (isset($ids) && $ids[1] == 'premium' && $route == 'show_form_self') || (isset($ids) && $ids[1] == 'premium' && $route == 'show_reval_self'))?'m-menu__item--active':''}}">
                                    ...
                                    <li class="m-menu__item m-menu__item--submenu m-menu__item--level-3 {{ ((Request::segment(2)=='application' && Request::segment(3) == '1_sharing') || (isset($ids) && $ids[1] == 'sharing' && $route == 'show_form_self') || (isset($ids) && $ids[1] == 'sharing' && $route == 'show_tripatite_self') || (isset($ids) && $ids[1] == 'sharing' && $route == 'show_reval_self'))?'m-menu__item--active':''}}">
