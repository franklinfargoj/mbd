                ...
                <div class="m-portlet__body m-portlet__body--spaced">
                    ...
                    <div class="m-form__group row mhada-lease-margin">
                        ...
                        <div class="col-sm-3 offset-sm-1 form-group">
                            ...
                            <input type="text" id="email" name="email" class="form-control form-control--custom m-input" value="{{ isset($data) ? $data->email : '' }}">
                            <span class="help-block">{{$errors->first('address')}}</span>
                        </div>
                        <div class="col-sm-3 offset-sm-1 form-group">
                            <label class="col-form-label" for="registration_no">Society Registration No:</label>

                            <input type="text" id="registration_no" name="registration_no" class="form-control form-control--custom m-input" value="{{ isset($data) ? $data->registration_no : '' }}">
                            <span class="help-block">{{$errors->first('address')}}</span>
                        </div>
                    </div>
                    <div class="m-form__group row mhada-lease-margin">
                        <div class="col-sm-7 form-group">
                            ...
                            <textarea id="address" name="address" class="form-control form-control--custom form-control--fixed-height m-input">{{ isset($data) ? $data->address : '' }}</textarea>
                            <span class="help-block">{{$errors->first('name')}}</span>
                        </div>
                    </div>
                    <div class="m-form__group row mhada-lease-margin">
                        <div class="col-sm-3 form-group">
                            ...
                            <input type="text" id="chairman_name" name="chairman_name" class="form-control form-control--custom m-input" value="{{ isset($data) ? $data->chairman_name : '' }}">
                            <span class="help-block">{{$errors->first('name')}}</span>
                        </div>
                        <div class="col-sm-3 offset-sm-1 form-group">
                            <label class="col-form-label" for="secretary_name">Secretary Name:</label>

                             <input type="text" id="secretary_name" name="secretary_name" class="form-control form-control--custom m-input" value="{{ isset($data) ? $data->secretary_name : '' }}">
                            <span class="help-block">{{$errors->first('address')}}</span>
                        </div>
                        <div class="col-sm-3 offset-sm-1 form-group">
                            <label class="col-form-label" for="name_of_architect">Architect/ Licence Surveyor Name:</label>

                            <input type="text" id="name_of_architect" name="name_of_architect" class="form-control form-control--custom m-input" value="{{ isset($data) ? $data->name_of_architect : '' }}">
                            <span class="help-block">{{$errors->first('address')}}</span>
                        </div>
                    </div>
                    <div class="m-form__group row mhada-lease-margin">
                        <div class="col-sm-3 form-group">
                            ...
                            <input type="text" id="architect_mobile_no" name="architect_mobile_no" class="form-control form-control--custom m-input" value="{{ isset($data) ? $data->architect_mobile_no : '' }}">
                            <span class="help-block">{{$errors->first('name')}}</span>
                        </div>
                        <div class="col-sm-3 offset-sm-1 form-group">
                            <label class="col-form-label" for="architect_address">Architect Address:</label>
                            <textarea id="architect_address" name="architect_address" class="form-control form-control--custom form-control--fixed-height m-input">{{ isset($data) ? $data->architect_address : '' }}</textarea>
                            <span class="help-block">{{$errors->first('address')}}</span>
                        </div>
                    </div>
                    <div class="m-form__group row mhada-lease-margin">
                        <div class="col-sm-3 form-group">
                            ...
                            <input type="password" id="password" name="password" class="form-control form-control--custom m-input" value="{{ isset($data) ? $data->password : '' }}">
                            <span class="help-block">{{$errors->first('name')}}</span>
                        </div>
                        <div class="col-sm-3 offset-sm-1 form-group">
                            <label class="col-form-label" for="confirm_psssword">Confirm Password:</label>
                             <input type="password" id="confirm_psssword" name="confirm_psssword" class="form-control form-control--custom m-input" value="{{ isset($data) ? $data->password : '' }}">
                            <span class="help-block">{{$errors->first('address')}}</span>
                        </div>
                    </div>
