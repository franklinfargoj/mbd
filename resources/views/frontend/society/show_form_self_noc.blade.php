            ...
            <form id="save_noc_application_self" role="form" method="post" class="m-form m-form--rows m-form--label-align-right floating-labels-form" action="{{ route('save_noc_application_self') }}">
                ...
                <div class="m-portlet__body m-portlet__body--spaced">
                    ...
                    <div class="m-form__group row mhada-lease-margin">
                        ...
                        <div class="col-xl-4 col-md-6 offset-xl-1 form-group">
                    ...
                    <div class="m-form__group row mhada-lease-margin">
                        <div class="col-xl-4 col-md-6 form-group"> <!-- offset-xl-1 -->
                        ...
                        <div class="col-xl-4 col-md-6 offset-xl-1 form-group"> <!-- offset-xl-1 -->
                    ...
                    <div class="m-form__group row mhada-lease-margin">
                        ...
                        <div class="col-xl-4 col-md-6 offset-xl-1 form-group"> <!-- offset-xl-1 -->
                            <label class="col-form-label" for="offsite_infra_charges_receipt_date">Offsite Infrastructure charges receipt date : <span class="star">*</span></label>
                             <input type="text" id="m_datepicker" name="offsite_infra_charges_receipt_date" class="form-control form-control--custom m-input m_datepicker" data-date-end-date="+0d" value="{{ old('offsite_infra_charges_receipt_date') }}" required
                            readonly="readonly">
