                ...
                <div class="m-content letter-form-content">
                    <div class="letter-form-subject">
                        ...
                        <p>
                            ...
                            <input class="letter-form-input" type="text" value="{{ isset($noc_application) ? $noc_application->request_form->demand_draft_amount : '' }}" readonly>  to CAO mumbai Board, on dated <input class="letter-form-input" type="text" value="{{date('j F Y',strtotime($noc_application->request_form->demand_draft_date))}}" readonly> Also, payment of offsite infrastructure charges to planning authority MHADA of Rs. <input class="letter-form-input" type="text" value="{{ isset($noc_application->request_form) ? $noc_application->request_form->offsite_infra_charges : '' }}" readonly> has been made on <input class="letter-form-input" type="text" value="{{date('j F Y',strtotime($noc_application->request_form->offsite_infra_charges_receipt_date))}}" readonly>.
                            The Receipts are enclosed herewith reference. Also have submitted various under taking, Indemnity bonds, and No dues certificate from EM.
