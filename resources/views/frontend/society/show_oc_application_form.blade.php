...
@section('content')
    ...
    <!-- BEGIN: Subheader -->
      ...
      We therefore request you to kindly grant us the NOC for  @if($oc_application->request_form->is_full_oc==1) Full OC @else Part OC @endif for rehab unit and sale component as mentioned above at the earliest.
        ...
        @if($oc_application->ocApplicationStatus[0]->status_id == '3' || $oc_application->ocApplicationStatus[0]->status_id == '4')
            <div class="m-login__form-action mt-4 mb-4">
                    <a href="{{ route('society_oc_edit') }}" class="btn btn-primary">
                        Back
                    </a>
                    <span style="float:right;margin-right: 20px">
                        <a href="{{ route('oc_documents_upload') }}" class="btn btn-primary">
                            Next
                        </a>
                    </span>
            </div>
