...
<div class="col-md-12">
    ...
    <div class="m-subheader px-0 m-subheader--top">
        <div class="d-flex align-items-center">
            ...
            {{ Breadcrumbs::render('noc_cc_documents_upload') }}
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                    <form action="{{ route('uploaded_documents_noc_cc') }}" method="post" enctype='multipart/form-data'
            ...
            <div>
                <div class="portlet-body">
                    <div class="m-portlet__body m-portlet__body--table m-portlet__body--serial-no m-portlet__body--serial-no-pdf">
                        ...
                        <form action="{{ route('add_documents_comment_noc_cc') }}" method="post" enctype='multipart/form-data'>
                            @csrf
