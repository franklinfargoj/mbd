    ...
    <div style="font-size: 18px;">
        ...
        <div>
            <div style="line-height: 1.5;">
                ...
                <p style="text-indent: 80px;">आम्ही <span style="width: 150px; border-bottom: 1px solid #000;">dfgdfg</span> सहकारी गृहनिर्माण संस्थेचे पदाधिकारी ( इमारत क्र. <span style="width: 50px; border-bottom: 1px solid #000;">{{ $society_details->building_no }}</span> पत्ता - <span style="width: 200px; border-bottom: 1px solid #000;">{{ $society_details->address }}</span>) आपणांस विनंती करतो की, आम्ही रहात असलेल्या सदरहू इमारतीचा @if($id == '2' || $id == '6')स्वय@endifपुनर्विकास विकास नियंत्रण नियमावली ३३ (५) अंतर्गत @if($id == '6' || $id == '17') गृहसाठा हिस्सेदारी @endif @if($id == '2' || $id == '13') अधिमुल्य आधारित @endif तत्वावर करु इच्छितो. आमच्या गृहनिर्माण संस्थेने दिनांक <span style="width: 100px; border-bottom: 1px solid #000;">{{ date('d-m-Y', strtotime($ol_application->request_form->date_of_meeting)) }}</span> रोजी @if($id == '2' || $id == '6')स्वय@endifपुनर्विकासासंदर्भात सर्वसाधारण सभेचा ठराव क्र. <span style="width: 200px; border-bottom: 1px solid #000;">{{ $ol_application->request_form->resolution_no }}</span> अन्वये निर्णय घेतला आहे.</p>
                <p style="text-indent: 80px;">आम्ही सहकारी गृहनिर्माण संस्थेच्या स्वय@endifपुनर्विकासाच्या कामांसाठी वि.नि.नि ३३ (५) मधील तरतूदींच्या अधिन राहून याबाबतचे सविस्तर आराखडे / नकाशे व @if($id == '2' || $id == '6')स्वय@endifपुनर्विकासाच्या कामावर देखरेख करण्यासाठी  <span style="width: 100px; border-bottom: 1px solid #000;">{{ $ol_application->request_form->architect_name }}</span> या वास्तुशास्त्रज्ञाची नियुक्ती केली आहे.आमच्या संस्थेच्या इमारतीच्या @if($id == '2' || $id == '6')स्वय@endifपुनर्विकासाचे काम करणेकरीता <span style="width: 200px; border-bottom: 1px solid #000;">{{ $ol_application->request_form->developer_name }}</span> या विकासकाची निवड केली आहे.</p>
