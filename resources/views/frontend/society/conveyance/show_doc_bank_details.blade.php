                            ...
                            <td>
                                ...
                                <span>
                                        ...
                                        @if($sc_application->scApplicationLog->status_id == 4)
                                            <a href="{{ route('delete_sc_upload_docs', encrypt($document->id)) }}" data-value='{{ $document->id }}'
                                                ...
                                                <div class="form-group m-form__group row">
                                                    @if(isset($sc_bank_details_fields[$i]))
                                                        <div class="col-sm-4 form-group">
                                                            ...
                                                            @php if(count($society_bank_details) > 0 && ($sc_application->scApplicationLog->status_id == config('commanConfig.conveyance_status.reverted') || $sc_application->scApplicationLog->status_id == config('commanConfig.conveyance_status.pending'))){ $readonly = ''; $value = $society_bank_details[$sc_bank_details_fields[$i]]; }else{ if(count($society_bank_details) == 0){ $readonly = ''; }else{ $readonly = 'readonly'; }  $value = $society_bank_details[$sc_bank_details_fields[$i]]; }  echo $comm_func->form_fields($sc_bank_details_fields[$i], 'text','' , '', $value, $readonly); @endphp
                                                    ...
                                                    @if(isset($sc_bank_details_fields[$i+1]))
                                                        <div class="col-sm-4 offset-sm-1 form-group">
                                                            ...
                                                            @php if(count($society_bank_details) > 0 && ($sc_application->scApplicationLog->status_id == config('commanConfig.conveyance_status.reverted') || $sc_application->scApplicationLog->status_id == config('commanConfig.conveyance_status.pending'))){ $readonly = ''; $value = $society_bank_details[$sc_bank_details_fields[$i+1]]; }else{ if(count($society_bank_details) == 0){ $readonly = ''; }else{ $readonly = 'readonly'; } $value = $society_bank_details[$sc_bank_details_fields[$i+1]]; }  echo $comm_func->form_fields($sc_bank_details_fields[$i+1], 'text','' , '', $value, $readonly); @endphp
