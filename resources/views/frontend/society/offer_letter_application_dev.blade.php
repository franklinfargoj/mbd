...
@csrf
	...
	<div class="m-content letter-form-content">
		<div class="letter-form-subject">
			<p><span class="font-weight-semi-bold">विषय :- </span>इमारत क्र. <input type="hidden" name="application_master_id" value="{{ $id }}"><input class="letter-form-input letter-form-input--xs" type="text" id="" name="building_no" value="{{ $society_details->building_no }}" required>, <input class="letter-form-input letter-form-input--xl" type="text" id="" name="username" value="{{ $society_details->username }}" required> सहकारी गृहनिर्माण संस्थेच्या स्वयंपुनर्विकासाच्या प्रस्तावास मंजूरी मिळण्याबाबतचा अर्ज.</p>
