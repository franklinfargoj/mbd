...
@section('body')
<div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--singin m-login--2 m-login-2--skin-2 m-login__container--rounded-fields sign-up-bg"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group m-form__group @if($errors->has('society_address')) has-error @endif">
                                    ...
                                    <textarea class="form-control m-input" placeholder="Society Address" name="society_address"
                                        value="{{ old('society_address') }}"></textarea>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group m-form__group @if($errors->has('society_contact_no')) has-error @endif">
                                    ...
                                    <input class="form-control m-input" type="text" placeholder="Society Contact No"
                                        name="society_contact_no" value="{{ old('society_contact_no') }}">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group m-form__group @if($errors->has('society_building_no')) has-error @endif">
                                    ...
                                    <input class="form-control m-input" type="text" placeholder="Society Building No"
                                        name="society_building_no" value="{{ old('society_building_no') }}">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group m-form__group @if($errors->has('society_registration_no')) has-error @endif">
                                    ...
                                    <input class="form-control m-input" type="text" placeholder="Society Registration No"
                                        name="society_registration_no" value="{{ old('society_registration_no') }}">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group m-form__group @if($errors->has('society_architect_mobile_no')) has-error @endif">
                                    <!-- <label for="" class="col-form-label">Confirm Password</label> -->
                                    <input class="form-control m-input" type="text" placeholder="Architect Mobile Number"
                                        name="society_architect_mobile_no" value="{{ old('society_architect_mobile_no') }}">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group m-form__group @if($errors->has('society_architect_address')) has-error @endif">
                                    ...
                                    <textarea class="form-control m-input" placeholder="Architect Address" name="society_architect_address"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group m-form__group @if($errors->has('society_password')) has-error @endif">
                                    ...
                                    <input class="form-control m-input" type="password" placeholder="Password" name="society_password"
                                        id="password" value="{{ old('society_password') }}">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group m-form__group @if($errors->has('society_password')) has-error @endif">
                                    <!-- <label for="" class="col-form-label">Password</label> -->
                                    <input class="form-control m-input" type="password" placeholder="Confirm Password"
                                        name="conf_society_password" value="{{ old('conf_society_password') }}">
                                    <span class="help-block">{{$errors->first('society_password')}}</span>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group m-form__group @if($errors->has('society_email')) has-error @endif">
                                    <!-- <label for="" class="col-form-label">Confirm Password</label> -->
                                    <input class="form-control m-input" type="email" placeholder="Optional Email Address"
                                        name="optional_society_email" value="{{ old('society_email') }}">
