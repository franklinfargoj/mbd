...
@csrf
	...
	<div class="m-content letter-form-content">
		<div class="letter-form-subject">
			...
			<p>आम्ही <input class="letter-form-input letter-form-input--lg" type="text" id="" name="username" value="{{ $society_details->username }}" required> सहकारी गृहनिर्माण संस्थेचे पदाधिकारी ( इमारत क्र. <input class="letter-form-input letter-form-input--xs" type="text" id="" name="building_no" value="{{ $society_details->building_no }}" required> पत्ता - <input class="letter-form-input letter-form-input--xl" type="text" id="" name="address" value="{{ $society_details->address }}" required>) आपणांस विनंती करतो की, आम्ही रहात असलेल्या सदरहू इमारतीचा स्वयंपुनर्विकास विकास नियंत्रण नियमावली ३३ (५) अंतर्गत @if($id == '6') गृहसत्ता हिस्सेदारी @else अधिमुल्य आधारित @endif तत्वावर करु इच्छितो. आमच्या गृहनिर्माण संस्थेने दिनांक <input class="letter-form-input letter-form-input--md" type="text" id="m_datepicker" name="date_of_meeting" required> रोजी स्वयंपुनर्विकासासंदर्भात सर्वसाधारण सभेचा ठराव क्र. <input class="letter-form-input letter-form-input--md" type="text" id="" name="resolution_no" required> अन्वये निर्णय घेतला आहे.</p>
