...
@section('content')
    <div class="col-md-12">
        ...
        <div class="m-portlet m-portlet--mobile m-portlet--forms-view">
            ...
            <form id="save_offer_letter_application_self" role="form" method="post" class="m-form m-form--rows m-form--label-align-right floating-labels-form" action="{{ route('save_oc_application_self') }}">
                @csrf
                <div class="m-portlet__body m-portlet__body--spaced">
                    ...
                    <div class="m-form__group row mhada-lease-margin">
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="department_name" name="department_name" class="form-control form-control--custom m-input" value="Executive Engineer / Estate Manager" readonly>
