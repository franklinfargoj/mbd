<div class="d-flex btn-icon-list">
	...
	<a class="d-flex flex-column align-items-center" title="Download Offer Letter Application" href="{{ route('society_offer_letter_application_download') }}"
    target="_blank" rel="noopener"><span class="btn-icon btn-icon--delete"><img src="{{ asset('/img/download-icon.svg')}}"></span>Download</a>
    ...
    @if($ol_applications->olApplicationStatus[0]->status_id == '7')
	    <a class="d-flex flex-column align-items-center" title="Download Offer Letter" href="{{ config('commanConfig.storage_server').'/'.$ol_applications->offer_letter_document_path }}"
	    target="_blank" rel="noopener"><span class="btn-icon btn-icon--delete"><img src="{{ asset('/img/download-icon.svg')}}"></span>Download</a>
    @endif
</div>