...
<a title="Download Offer Letter Application" href="{{ route('society_offer_letter_application_download') }}" target="_blank" rel="noopener"><i class="icon-pencil"></i>Download Offer Letter Application</a>
