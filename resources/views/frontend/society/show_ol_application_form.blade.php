    ...
    <!-- BEGIN: Subheader -->
        ...
        <div class="m-content letter-form-content">
            <div class="letter-form-subject">
                ...
                <p>आम्ही <input class="letter-form-input" type="text" id="" name="name" value="{{ $society_details->name }}" readonly> सहकारी गृहनिर्माण संस्थेचे पदाधिकारी ( इमारत क्र. <input class="letter-form-input" type="text" id="" name="building_no" value="{{ $society_details->building_no }}" readonly> पत्ता - <input class="letter-form-input" type="text" id="" name="address" value="{{ $society_details->address }}" readonly>) आपणांस विनंती करतो की, आम्ही रहात असलेल्या सदरहू इमारतीचा पुनर्विकास विकास नियंत्रण नियमावली ३३ (५) अंतर्गत @if($id == '6' || $id == '17') गृहसत्ता हिस्सेदारी @endif @if($id == '2' || $id == '13') अधिमुल्य आधारित @endif तत्वावर करु इच्छितो. आमच्या गृहनिर्माण संस्थेने दिनांक <input class="letter-form-input" type="text" name="date_of_meeting" value="{{ date(config('commanConfig.dateFormat'), strtotime($ol_application->request_form->date_of_meeting)) }}" readonly> रोजी @if($id == '2' || $id == '6')स्वयंपुनर्विकास@endif @if($id == '13' || $id == '17')पुनर्विकास@endifसंदर्भात सर्वसाधारण सभेचा ठराव क्र. <input class="letter-form-input" type="text" id="" name="resolution_no" value="{{ $ol_application->request_form->resolution_no }}" readonly> अन्वये निर्णय घेतला आहे.</p>
