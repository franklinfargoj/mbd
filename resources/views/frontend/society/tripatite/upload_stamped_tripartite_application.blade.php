                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="d-flex flex-column h-100 two-cols">
                                        ...
                                        <div class="mt-auto">
                                            <a title="Donwload Tripartite Application" href="{{ route('society_tripartite_application_download', encrypt($ol_applications->id)) }}" target="_blank" class="btn btn-primary" rel="noopener"><i class="icon-pencil"></i>Donwload Tripartite Application</a>
                                        </div>
                                    </div>
                                </div>
