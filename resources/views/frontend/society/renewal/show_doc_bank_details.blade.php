                        ...
                        <div class="remarks-suggestions table--box-input">
                            <div class="mt-3">
                                ...
                                <div class="@if($errors->has('society_documents_comment')) has-error @endif">
                                    <textarea name="society_documents_comment" rows="5" cols="30" id="society_documents_comment" class="form-control form-control--custom" {{ ($sc_application->srApplicationLog->status_id == config('commanConfig.renewal_status.forwarded'))? 'readonly': '' }}>@if(isset($renewal_doc_comments) && count($renewal_doc_comments) > 0) {{ $renewal_doc_comments->society_documents_comment }} @endif</textarea>
