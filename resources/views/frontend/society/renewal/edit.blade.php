        ...
        <div class="m-portlet m-portlet--mobile m-portlet--forms-view">
            ...
            <form id="save_sc_application" role="form" method="post" class="m-form m-form--rows m-form--label-align-right" action="{{ route('society_renewal.update', $id) }}" enctype="multipart/form-data">
                ...
                <div class="m-portlet__body m-portlet__body--spaced">
                    ...
                    {{--                    @php dd($sc_application->sr_form_request[$field_names[1]]); @endphp--}}
                            ...
                            @if(isset($field_names[$i]))
                                <div class="col-sm-4 form-group">
                                    ...
                                    @elseif(strpos($field_names[$i], 'date') != null)
                                        @php echo $comm_func->form_fields($field_names[$i], 'date', '', '', date(config('commanConfig.dateFormat'), strtotime($sc_application->sr_form_request[$field_names[$i]]))) @endphp
                            ...
                            @if(isset($field_names[$i+1]))
                                <div class="col-sm-4 offset-sm-1 form-group">
                                    ...
                                    @elseif(strpos($field_names[$i+1], 'date') != null)
                                        @php echo $comm_func->form_fields($field_names[$i+1], 'date', '', '', date(config('commanConfig.dateFormat'), strtotime($sc_application->sr_form_request[$field_names[$i+1]]))) @endphp
