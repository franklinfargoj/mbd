...
<div class="col-md-12"> 
    ...
    <div class="m-subheader px-0 m-subheader--top">
        <div class="d-flex align-items-center">
            ...
            <a href="{{ route('reval_documents_upload',encrypt($ol_applications->id)) }}" class="btn btn-link ml-auto"><i class="fa fa-long-arrow-left" style="padding-right: 8px;"></i>Back</a>
            @else
...
<script type="text/javascript">
    ...
    $("#uploadBtn").click(function(){
        if ($("#myFrm").valid() == true){
            ...
            $.ajax({
                url: "/save_reval_other_documents",
                data: form_data,
                dataType : "json",
                type: 'POST',
                contentType: false, 
    ...
    function deleteDocument(id){
        ...
        if (valid){
            ...
            $.ajax({
                url: "/delete_reval_other_documents",
                data: form_data,
                type: 'POST',
                dataType : "json",
                contentType: false,
