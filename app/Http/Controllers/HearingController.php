...
//dd($todaysHearing);
    ...
    public function getHearingLogs($hearing_id){
        ...
        $hearing_data = Hearing::with(['hearingSchedule1.userDetails.roleDetails','hearingUploadCaseJudgement','hearingUploadCaseJudgement.userDetails','hearingUploadCaseJudgement.userDetails.roleDetails','hearingPrePostSchedule.userDetails','hearingPrePostSchedule.userDetails.roleDetails','hearingSchedule1.userDetails'])->where('id', $hearing_id)->orderBy('id','desc')->first();
